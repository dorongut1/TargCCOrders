Partial Public Class ctlc_IndexFragmentationCol
  ...
  Private Sub ctlc_IndexFragmentationCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csIndexFragmentation.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csIndexFragmentation.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_IndexFragmentationCol_evtLoaded() Handles Me.evtLoaded 
