Partial Public Class ctlc_PermissionCol
  ...
  Private Sub ctlc_PermissionCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csPermission.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csPermission.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_PermissionCol_evtLoaded() Handles Me.evtLoaded 
