Partial Public Class ctlc_UserCol
  ...
  Private Sub ctlc_UserCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csUser.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csUser.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_UserCol_evtLoaded() Handles Me.evtLoaded 
