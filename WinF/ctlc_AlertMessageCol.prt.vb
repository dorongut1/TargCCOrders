Partial Public Class ctlc_AlertMessageCol
  ...
  Private Sub ctlc_AlertMessageCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csAlertMessage.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csAlertMessage.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_AlertMessageCol_evtLoaded() Handles Me.evtLoaded 
