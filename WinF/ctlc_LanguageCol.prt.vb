Partial Public Class ctlc_LanguageCol
  ...
  Private Sub ctlc_LanguageCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLanguage.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLanguage.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LanguageCol_evtLoaded() Handles Me.evtLoaded 
