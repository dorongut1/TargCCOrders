Partial Public Class ctlc_TableSizeCol
  ...
  Private Sub ctlc_TableSizeCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csTableSize.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csTableSize.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_TableSizeCol_evtLoaded() Handles Me.evtLoaded 
