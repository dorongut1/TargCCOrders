Partial Public Class ctlccSupplierOrderCol
  ...
  Private Sub ctlccSupplierOrderCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsSupplierOrder.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsSupplierOrder.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccSupplierOrderCol_evtLoaded() Handles Me.evtLoaded 
