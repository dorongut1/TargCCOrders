Partial Public Class ctlc_LoggedAlertCol
  ...
  Private Sub ctlc_LoggedAlertCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLoggedAlert.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLoggedAlert.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LoggedAlertCol_evtLoaded() Handles Me.evtLoaded 
