Partial Public Class ctlc_UserLoginKeyCol
  ...
  Private Sub ctlc_UserLoginKeyCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csUserLoginKey.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csUserLoginKey.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_UserLoginKeyCol_evtLoaded() Handles Me.evtLoaded 
