Public Class ctlc_AlertMessageCol
  ...
  Public Event evtUpdated(ByVal vAlertMessage As csAlertMessage) 
  Private Event evtBeforeDelete(ByVal vAlertMessage As csAlertMessage, ByRef rCancel As Nullable(Of Boolean)) 
  
  Public Event evtRowClicked(ByVal vAlertMessage As csAlertMessage) 
  Public Event evtRowDoubleClicked(ByVal vAlertMessage As csAlertMessage, ByRef rHandled As Boolean) 
  Public Event evtUnChosen() 
 
  Public Event evtOverrideLoadCbo(ByVal vParentName As csAlertMessage.enmParentProperty, ByRef rComboListTypeToLoad As clsEnums.enmComboListType, ByRef rParentID As Long, ByRef rComboList As clsComboList, ByRef rPrompt As String) 
  ...
  Public Class clsLoadParameters 
    ...
    Public Property DoNotSummarizeProperties As List(Of csAlertMessage.enmSummarizeableProperty) 
    Public Property SpreadsheetShowAllFields As Nullable(Of Boolean) 
    Public Property GridTitle As String 
    Public Property ReportTitle As String 
    Public Property [ReadOnly] As Boolean 
    Public Property CbosDoNotLoad As List(Of csAlertMessage.enmParentProperty) 
    Public Property ColumnsReadOnly As List(Of csAlertMessage.enmProperty) 
    Public Property ColumnsHide As List(Of csAlertMessage.enmProperty) 
    Public Property ColumnsFormat As Dictionary(Of csAlertMessage.enmProperty, String) 
    Public Property ColumnsOrdinalPosition As Dictionary(Of csAlertMessage.enmProperty, Integer) 
    Public Property ColumnsAlignment As Dictionary(Of csAlertMessage.enmProperty, DataGridViewContentAlignment) 
    Public Property ColumnsHeaderText As Dictionary(Of csAlertMessage.enmProperty, String) 
    ...
    Public Sub New() 
      _SummarizeGrid = True 
      _DoNotSummarizeProperties = New List(Of csAlertMessage.enmSummarizeableProperty) 
      _SpreadsheetShowAllFields = Nothing 
      _GridTitle = "" 
      _ReportTitle = "" 
      _ReadOnly = False 
      _CbosDoNotLoad = New List(Of csAlertMessage.enmParentProperty) 
      _ColumnsReadOnly = New List(Of csAlertMessage.enmProperty) 
      _ColumnsHide = New List(Of csAlertMessage.enmProperty) 
      _ColumnsFormat = New Dictionary(Of csAlertMessage.enmProperty, String) 
      _ColumnsOrdinalPosition = New Dictionary(Of csAlertMessage.enmProperty, Integer) 
      _ColumnsAlignment = New Dictionary(Of csAlertMessage.enmProperty, DataGridViewContentAlignment) 
      _ColumnsHeaderText = New Dictionary(Of csAlertMessage.enmProperty, String) 
  ...
  Private WithEvents _AlertMessageCol As csAlertMessageCol
  Private WithEvents _AlertMessageColFullLength As csAlertMessageCol
  ...
  'Properties 
  Public ReadOnly Property [SelectedAlertMessage]() As csAlertMessage 
    Get 
      If dgvAlertMessage.SelectedRows.Count = 0 OrElse _Loading = True Then Return Nothing 
      Dim RowIndex As Integer = dgvAlertMessage.SelectedRows(0).Cells(0).RowIndex 
      If RowIndex < 0 Then Return Nothing 
      If _Summarized = True AndAlso RowIndex = dgvAlertMessage.Rows.Count - 1 Then dgvAlertMessage.ClearSelection() : RaiseEvent evtUnChosen() : Return Nothing 
      Return _AlertMessageCol(RowIndex) 
    End Get 
  End Property 
  
  Public ReadOnly Property [AlertMessageCol]() As csAlertMessageCol 
    Get 
      Return _AlertMessageCol 
    End Get 
  End Property 
 
  Public Function LoadControl(ByVal vLoadParameters As clsLoadParameters, ByVal vRequester As clsRequester) As clsFault
    Dim pAlertMessageCol As New csAlertMessageCol(vIsLocalized:=True) 
    If LocalizedTextLanguage <> clsEnums.enmLanguage.UD Then pAlertMessageCol.OverrideDefaultLanguage(LocalizedTextLanguage) 
    Dim pFault As clsFault 
 
    _Requester = vRequester 
    _LoadParameters = vLoadParameters 
 
    pFault = pAlertMessageCol.Fill(_Requester) 
    If pFault.isOK = False Then Return pFault 
 
    pFault = LoadControl(pAlertMessageCol)
    Return pFault 
  End Function 
 
  Public Function LoadControl(vAlertMessageCol As csAlertMessageCol, ByVal vLoadParameters As clsLoadParameters, ByVal vRequester As clsRequester) As clsFault
 
    _Requester = vRequester 
    _LoadParameters = vLoadParameters 
 
    Return LoadControl(vAlertMessageCol) 
  End Function
  
  Private Function LoadControl(vAlertMessageCol As csAlertMessageCol) As clsFault
    ...
    'keep safe in case 
    Dim pColumnsHides As List(Of csAlertMessage.enmProperty) = Nothing 
    If _LoadParameters.IsSumFillOnTheFly Then 
      pColumnsHides = New List(Of csAlertMessage.enmProperty) 
    ...
    For Each l In _LoadParameters.ColumnsReadOnly 
      If l = csAlertMessage.enmProperty.ID Then colID.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Number Then colNumber.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Description Then colDescription.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Type Then colType.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Severity Then colSeverity.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Message Then colMessage.ReadOnly = True 
      If l = csAlertMessage.enmProperty.Action Then colAction.ReadOnly = True 
    Next 
    ...
    dgvAlertMessage.DoubleBuffered(True) 
 
    pFault = vAlertMessageCol.LoadLookupAndEnumText(_Requester) : If Not pFault.isOK Then Return pFault 
    
    'Now transfer to local collection 
    _AlertMessageColFullLength = vAlertMessageCol.Clone() 
 
    'Truncate the strings 
    _AlertMessageCol = vAlertMessageCol 
    If _LoadParameters.TruncateStrings Then 
      _AlertMessageCol.TruncateStrings() 
    Else 
      dgvAlertMessage.DefaultCellStyle.WrapMode = DataGridViewTriState.True 
      dgvAlertMessage.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCellsExceptHeaders 
    End If 
    ...
    If sReadOnlyHandled = False Then 
      ...
      Else 
        If (_Requester.UILang = clsEnums.enmLanguage.en AndAlso LocalizedTextLanguage = clsEnums.enmLanguage.UD) OrElse LocalizedTextLanguage = clsEnums.enmLanguage.en Then 
          colMessageLocalized.ReadOnly = True 
          colActionLocalized.ReadOnly = True 
        End If 
      End If 
    ...
    Next 
    For Each lCol As DataGridViewColumn In dgvAlertMessage.Columns 
    ...
    'Hide columns  
    For Each p As csAlertMessage.enmProperty In _LoadParameters.ColumnsHide 
    ...
    For Each pD In _LoadParameters.ColumnsHeaderText 
      dgvAlertMessage.Columns("col" & pD.Key.ToString).HeaderText = pD.Value 
    Next 
 
    'Format Columns 
    For Each pD In _LoadParameters.ColumnsFormat 
      dgvAlertMessage.Columns("col" & pD.Key.ToString).DefaultCellStyle.Format = pD.Value 
    Next 
 
    'ordinal position 
    For Each pD In _LoadParameters.ColumnsOrdinalPosition 
      dgvAlertMessage.Columns("col" & pD.Key.ToString).DisplayIndex = pD.Value 
    Next 
    _GridSettings.Update(Me, _Requester)
    
    'Align Columns 
    For Each pD In _LoadParameters.ColumnsAlignment 
      dgvAlertMessage.Columns("col" & pD.Key.ToString).DefaultCellStyle.Alignment = pD.Value 
    Next 
    ...
    dgvAlertMessage.ClearSelection()
    bsCtlAlertMessage.DataSource = Nothing 
    ...
    Catch ex As Exception
      Return pFault.LogException(ex, "LoadGrid", "TRGT-AlertMessage-090124-2345", _Requester) 
    End Try
    ...
    lblStatus.Text = dgvAlertMessage.RowCount & " rows" 
    ...
    If _SortList IsNot Nothing Then 
      ...
      For Each i In _SortList 
        ...
        dgvAlertMessage_ColumnHeaderMouseClick(Me, pE) 
      Next 
      _AutoSorting = False 
    End If 
  ...
  Private Sub LoadGrid()
    ...
    If dgvAlertMessage.SelectedRows.Count > 0 Then 
      pRowIndex = dgvAlertMessage.SelectedRows(0).Cells(0).RowIndex 
    Else 
      If dgvAlertMessage.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
        pRowIndex = dgvAlertMessage.CurrentCellAddress.Y 
      End If 
    End If 
    ...
    bsCtlAlertMessage.DataSource = Nothing 
    bsCtlAlertMessage.DataSource = _AlertMessageCol
    ...
    For Each p As ToolStripMenuItem In btnColumns.DropDownItems 
      ...
      p.Checked = dgvAlertMessage.Columns("col" & pMenuItemProprty).Visible 
    Next 
 
    If pRowIndex >= 0 Then 
      If _Summarized = True Then 
        If pRowIndex <= _AlertMessageCol.Count - 2 Then 
          dgvAlertMessage.Rows(pRowIndex).Selected = True 
        End If 
      Else 
        If pRowIndex <= _AlertMessageCol.Count - 1 Then 
          dgvAlertMessage.Rows(pRowIndex).Selected = True 
        End If 
      End If 
    End If 
  ...
  Private Function LoadSupportingCombos() As clsFault
    ...
    pPrompt = "" 
    pEnumCol = Nothing 
    RaiseEvent evtOverrideLoadCbo(csAlertMessage.enmParentProperty.Type, Nothing, Nothing, pEnumCol, pPrompt) 
    ...
    pPrompt = "" 
    pEnumCol = Nothing 
    RaiseEvent evtOverrideLoadCbo(csAlertMessage.enmParentProperty.Severity, Nothing, Nothing, pEnumCol, pPrompt) 
    If pEnumCol Is Nothing Then 
      pEnumCol = New clsComboList 
    ...
    bsSeverity.DataSource = pEnumCol 
    colSeverity.Tag = pPrompt 
  ...
  Private Sub SetUpBNButtons(ByVal vInEdit As Boolean)
    ...
    Else 
      ...
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_AlertMessageUpdate, _Requester) = True AndAlso _LoadParameters.ImportButtonHide = False Then btnImport.Visible = vInEdit Else btnImport.Visible = False 
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_AlertMessageUpdate, _Requester) = True Then btnAdd.Visible = vInEdit Else btnAdd.Visible = False 
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_AlertMessageDelete, _Requester) = True Then btnDelete.Visible = vInEdit Else btnDelete.Visible = False 
    ...
    If vInEdit = True AndAlso _LoadParameters.AddEditDeleteButtonsHide = False Then 
      colID.ReadOnly = True 
      dgvAlertMessage.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 
      dgvAlertMessage.SelectionMode = DataGridViewSelectionMode.CellSelect 
      _DVGDirty = False 
    Else 
      dgvAlertMessage.EditMode = DataGridViewEditMode.EditProgrammatically 
      dgvAlertMessage.SelectionMode = DataGridViewSelectionMode.FullRowSelect 
      dgvAlertMessage.AllowUserToDeleteRows = False 
      dgvAlertMessage.AllowUserToAddRows = False 
      'Don't automatically set the 1st one If dgvAlertMessage.Rows.Count > 0 Then 
      '  Dim pCurrentRow As Integer 
      '  pCurrentRow = dgvAlertMessage.CurrentRow.Index 
      '  dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(pCurrentRow).Cells(0) 
      '  dgvAlertMessage.Rows(pCurrentRow).Selected = True 
      'End If 
    End If 
    ...
    Else 
      If _AlertMessageCol.Count = 0 Then 
        btnSpreadsheet.Enabled = False 
        btnReport.Enabled = False 
      Else 
  ...
  Private Sub btnImport_Click(sender As Object, e As EventArgs) Handles btnImport.Click 
    ...
    pFieldList.Append("Number, ") 
    pFieldList.Append("Description, ") 
    pFieldList.Append("Type (DB Code), ") 
    pFieldList.Append("Severity (DB Code), ") 
    pFieldList.Append("Message, ") 
    pFieldList.Append("MessageLocalized (" & _AlertMessageCol.LocalizedLanguage.FastToString() & "), ") 
    pFieldList.Append("Action, ") 
    pFieldList.Append("ActionLocalized (" & _AlertMessageCol.LocalizedLanguage.FastToString() & "), ") 
    ...
    pMessage &= Environment.NewLine 
    pMessage &= Environment.NewLine 
    pMessage &= "If there is no ID field (the 1st field is Number), then I will delete the table and recreate it with the data in this spreadsheet" 
    pMessage &= Environment.NewLine 
    pMessage &= Environment.NewLine 
    ...
    'Now Load the data 
    Dim pIncomingAlertMessages As New csAlertMessageCol(vIsLocalized:=True) 
    If LocalizedTextLanguage <> clsEnums.enmLanguage.UD Then pIncomingAlertMessages.OverrideDefaultLanguage(LocalizedTextLanguage) 
    ...
    Using pReader As New Microsoft.VisualBasic.FileIO.TextFieldParser(ofd.FileName, System.Text.Encoding.Unicode) 
      ...
      While Not pReader.EndOfData 
        ...
        Try 
          Dim pIncomingAlertMessage As New csAlertMessage(vIsLocalized:=True) 
          If LocalizedTextLanguage <> clsEnums.enmLanguage.UD Then pIncomingAlertMessage.OverrideDefaultLanguage(LocalizedTextLanguage) 
          pIncomingAlertMessage.Tag = "Row " & pRow.ToString 
          pCurrentRow = pReader.ReadFields() 
          If pRow = 0 Then 
            If pCurrentRow.Length = pNumberOfFields - 1 Then 
              pNoPrimaryKey = True 
              pFault = csAlertMessageCol.Delete(_Requester) : If Not pFault.isOK Then ShowFault(pFault, _Requester) : Return 
          ...
          If pCurrentRow.Length <> pNumberOfFields Then 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ": There should be " & pNumberOfFields & " fields, but there are actually " & pCurrentRow.Length & " fields." 
            pIncomingAlertMessages.Add(pIncomingAlertMessage) 
            Continue While 
          End If 
          ...
          If pNoPrimaryKey = False Then 
            Try 
              pFieldNo += 1 
              pFieldName = "ID" 
              pIncomingAlertMessage.ID = CType(pCurrentRow(pFieldNo), Long) 
            Catch ex As Exception 
              pErrorFound = True 
              pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
            End Try 
          End If 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Number" 
            pIncomingAlertMessage.Number = CType(pCurrentRow(pFieldNo), Integer) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            ...
            pIncomingAlertMessage.Description = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Type" 
            pIncomingAlertMessage.Type = clsEnums.TranslateEnmFaultType(pCurrentRow(pFieldNo)) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Severity" 
            pIncomingAlertMessage.Severity = clsEnums.TranslateEnmFaultSeverity(pCurrentRow(pFieldNo)) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Message" 
            pIncomingAlertMessage.Message = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "MessageLocalized" 
            pIncomingAlertMessage.MessageLocalized = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Action" 
            pIncomingAlertMessage.Action = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "ActionLocalized" 
            pIncomingAlertMessage.ActionLocalized = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingAlertMessage.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
 
          If pIncomingAlertMessage.Tag = "Row " & pRow.ToString Then 
            pIncomingAlertMessage.Tag &= ": OK" 
          End If 
      ...
      If pErrorFound = True Then 
        Cursor = Cursors.Default 
        Try 
          My.Computer.FileSystem.WriteAllText(pFilenameOut, pIncomingAlertMessages.ToCSV, False) 
        Catch ex As Exception 
    ...
    pFault = pIncomingAlertMessages.UpdateFromCollection(_Requester) 
    ...
    pErrorFound = False 
    For Each p In pIncomingAlertMessages 
      If p.Tag <> "OK" Then 
        pErrorFound = True 
      End If 
    Next 
    If pErrorFound = True Then 
      ...
      Exit Sub 
    Else 
      _AlertMessageCol = pIncomingAlertMessages 
      LoadGrid() 
  ...
  Private Sub DoEdit() 
    ...
    If dgvAlertMessage.Focused = True AndAlso dgvAlertMessage.SelectedRows.Count > 0 Then 
      pCellRow = dgvAlertMessage.CurrentCell.RowIndex 
      pCellCol = dgvAlertMessage.CurrentCell.ColumnIndex 
    End If 
 
    Try 'in case it's empty 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(0).Cells(0) 
      dgvAlertMessage.CurrentCell.Selected = True 
    Catch ex As Exception 
    End Try 
 
 
    'remove summary row 
    If _LoadParameters.SummarizeGrid = True AndAlso _AlertMessageCol.Count > 0 AndAlso _AlertMessageCol(_AlertMessageCol.Count - 1).ID = 0 Then 
      _AlertMessageCol.RemoveAt(_AlertMessageCol.Count - 1) 
      bsCtlAlertMessage.DataSource = Nothing 
      bsCtlAlertMessage.DataSource = _AlertMessageCol 
      _Summarized = False 
    End If 
    ...
    If pCellRow >= 0 AndAlso pCellCol >= 0 Then 
      dgvAlertMessage.Focus() 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(pCellRow).Cells(pCellCol) 
      dgvAlertMessage.CurrentCell.Selected = True 
    ElseIf _AlertMessageCol.Count = 0 Then 
    Else 
  ...
  Private Sub DoAdd() 
    ...
    bsCtlAlertMessage.AddNew() 
 
    'Now choose any needed fields 
    Dim pEntity As csAlertMessage 
    pEntity = CType(bsCtlAlertMessage.Current, csAlertMessage) 
  ...
  Private Function DoDelete() As clsFault 
    ...
    If dgvAlertMessage.CurrentCell Is Nothing Then Return pFault 
    
    If dgvAlertMessage.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
      Dim pAlertMessage As csAlertMessage 
      pAlertMessage = CType(bsCtlAlertMessage.Current, csAlertMessage) 
      If pAlertMessage Is Nothing Then 
        pFault.LogFreeTextFault("There is no AlertMessage to delete", "", "TRGT-110303-165408", _Requester) 
        Return pFault 
      End If 
      Dim pOriginalCol As Integer = dgvAlertMessage.CurrentCell.ColumnIndex 
      Dim pOriginalRow As Integer = dgvAlertMessage.CurrentCell.RowIndex 
      'show row as selected  
      dgvAlertMessage.SelectionMode = DataGridViewSelectionMode.FullRowSelect 
      dgvAlertMessage.EditMode = DataGridViewEditMode.EditProgrammatically 
      dgvAlertMessage.CurrentRow.Selected = True 
      If pAlertMessage.ID > 0 Then 
        Dim pRequest As String = "Are you sure you want to delete '" & pAlertMessage.Number.ToString() & "'?" 
        Dim pCancel As Nullable(Of Boolean) = Nothing 
        RaiseEvent evtBeforeDelete(pAlertMessage, pCancel) 
        ...
        ElseIf pCancel Is Nothing Then 
          ...
          If pResponse = frmMessageOrInputBox.enmButtonReturned.No Then 
            dgvAlertMessage.SelectionMode = DataGridViewSelectionMode.CellSelect 
            dgvAlertMessage.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 
            dgvAlertMessage.Rows(pOriginalRow).Cells(pOriginalCol).Selected = True 
            Return pFault 
          End If 
        End If 
        pFault = pAlertMessage.Delete(_Requester) : If pFault.isOK = False Then Return pFault 
      End If 
      bsCtlAlertMessage.Remove(bsCtlAlertMessage.Current) 
      LoadGrid() 
    End If 
    Return pFault 
  End Function 
  Private Sub DoCeaseEdit() 
    ...
    If _DVGDirty = True Then 
      ...
      Exit Sub 
    End If 
    Dim pAlertMessage As csAlertMessage = CType(bsCtlAlertMessage.Current, csAlertMessage) 
    If pAlertMessage IsNot Nothing Then 
      If pAlertMessage.ID = 0 Then 
    ...
    End If 
    SetUpBNButtons(False) 
    If _AlertMessageCol.Count > 0 AndAlso dgvAlertMessage.CurrentCell IsNot Nothing Then 
      For i As Integer = 0 To dgvAlertMessage.Columns.Count - 1 
        If dgvAlertMessage.Columns(i).Visible Then 
          dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(dgvAlertMessage.CurrentCell.RowIndex).Cells(i) 
          Exit For 
        End If 
      Next 
      dgvAlertMessage.Refresh() 
      dgvAlertMessage.Rows(dgvAlertMessage.CurrentCell.RowIndex).Selected = True 
    Else 
      dgvAlertMessage.Refresh() 
    End If 
  End Sub 
  'Grid RowValidating 
  Private Sub dgvAlertMessage_RowValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellCancelEventArgs) Handles dgvAlertMessage.RowValidating 
    If _Loading = True OrElse dgvAlertMessage.EditMode = DataGridViewEditMode.EditProgrammatically Then Exit Sub 
    Dim pCancel As Boolean 
    pCancel = UpdateRow() 
    If pCancel = True Then 
      e.Cancel = True 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(e.RowIndex).Cells(e.ColumnIndex) 
    End If 
  End Sub 
  'CellFormatting  
  Private Sub dgvAlertMessage_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgvAlertMessage.CellFormatting 
    '_Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
 
    If dgvAlertMessage.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
      If dgvAlertMessage.Columns(e.ColumnIndex).ReadOnly = False Then 
        Exit Sub 
      End If 
    End If 
    ...
    'If dgvAlertMessage.Columns(e.ColumnIndex).Name = colRecommendedQuantityToOrder.Name Then 
    '  If pAlertMessage Is Nothing Then pAlertMessage = CType(dgvAlertMessage.Rows(e.RowIndex).DataBoundItem, csAlertMessage) ' Only assign it if needed 
    '  If pAlertMessage.CustomerOrders > 10 Then 
    '    e.CellStyle.ForeColor = Color.Red 
    '    If pAlertMessage.CustomerOrders > 100 Then 
    '      e.CellStyle.BackColor = Color.LightYellow 
    '    End If 
    '  End If 
    'End If 
    'If dgvAlertMessage.Columns(e.ColumnIndex).Name = colRAV.Name Then 
    '  If pAlertMessage Is Nothing Then pAlertMessage = CType(dgvAlertMessage.Rows(e.RowIndex).DataBoundItem, csAlertMessage) ' Only assign it if needed
    '  If pAlertMessage.RAV > 10 Then 
    '    e.CellStyle.ForeColor = Color.Red 
    '    If pAlertMessage.RAV - pAlertMessage.MaximumStock > 100 Then 
    '      e.CellStyle.BackColor = Color.LightYellow 
    '    End If 
    '  End If 
    'End If 
 
    'Debug.Print("loc x,y:" & e.RowIndex & ", " & e.ColumnIndex & ": GetType" & dgvAlertMessage.Columns(e.ColumnIndex).GetType.ToString & ": zValue" & e.Value.ToString) 
    If dgvAlertMessage.Columns(e.ColumnIndex).GetType.ToString = "System.Windows.Forms.DataGridViewComboBoxColumn" Then 
      Dim pCol As System.Windows.Forms.DataGridViewComboBoxColumn = CType(dgvAlertMessage.Columns(e.ColumnIndex), System.Windows.Forms.DataGridViewComboBoxColumn) 
      Dim pTag As String = "" 
      ...
      If pTag <> "" Then 
        If e.Value Is Nothing Then 
          'e.Value = "## INVALID ##" 
          e.Value = "* BadCode '" & dgvAlertMessage.Rows(e.RowIndex).Cells(e.ColumnIndex).Value.ToString() & "' *" 
    ...
    If dgvAlertMessage.Columns(e.ColumnIndex).GetType.Name.Equals("DataGridViewImageColumn", StringComparison.OrdinalIgnoreCase) Then 
      If e.Value Is Nothing Then 
    ...
    If _Summarized = True Then 
      If e.RowIndex = dgvAlertMessage.Rows.Count - 1 Then 
        If e.Value IsNot Nothing Then 
          ...
          ElseIf e.Value.ToString = "0" Then 
            e.Value = "" 
          Else 
            If _SummaryOverFlow.IndexOf(dgvAlertMessage.Columns(e.ColumnIndex).Name.Substring(3)) >= 0 Then 
              e.Value = "* OVERFLOW *" 
            End If 
          End If 
        Else 
    ...
    End If 
  End Sub 
  Private Sub dgvAlertMessage_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles dgvAlertMessage.CellValueChanged 
    If e.RowIndex < 0 Then Exit Sub 
 
  End Sub 
 
  'Grid Sort
  Private Sub dgvAlertMessage_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvAlertMessage.ColumnHeaderMouseClick
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    Dim pNewColumn As DataGridViewColumn = dgvAlertMessage.Columns(e.ColumnIndex)
    If bsCtlAlertMessage.Current Is Nothing Then Exit Sub
    ...
    Cursor = Cursors.WaitCursor
    dgvAlertMessage.SuspendLayout()

    Dim pAlertMessage As csAlertMessage
    Dim pID As Long = 0 
    If dgvAlertMessage.SelectedRows.Count > 0 Then 
    pAlertMessage = CType(bsCtlAlertMessage.Current, csAlertMessage)
      pID = pAlertMessage.ID 
    End If 
    ...
    Dim pAlertMessageCol As csAlertMessageCol
    pAlertMessageCol = CType(bsCtlAlertMessage.DataSource, csAlertMessageCol)

    Dim pSummaryRow As csAlertMessage = Nothing 
    If _Summarized = True Then 
      pSummaryRow = pAlertMessageCol(pAlertMessageCol.Count - 1) 
      pAlertMessageCol.RemoveAt(pAlertMessageCol.Count - 1) 
    End If 
    ...
    If pNewSortOrder = SortOrder.Ascending Then
      If _PrevSortColumn IsNot Nothing AndAlso _PrevSortColumn IsNot pNewColumn Then 
        ...
        For iCntr As Integer = 0 To pAlertMessageCol.Count - 1 
          pAlertMessageCol(iCntr).Tag = iCntr.ToString("0000000000") 
        Next 
      End If 
      If pNewColumn Is colID Then
        pAlertMessageCol.SortByID()
      ElseIf pNewColumn Is colNumber Then
        pAlertMessageCol.SortByNumber()
      ElseIf pNewColumn Is colDescription Then
        pAlertMessageCol.SortByDescription()
      ElseIf pNewColumn Is colType Then
        pAlertMessageCol.SortByType()
      ElseIf pNewColumn Is colSeverity Then
        pAlertMessageCol.SortBySeverity()
      ElseIf pNewColumn Is colMessage Then
        pAlertMessageCol.SortByMessage()
      ElseIf pNewColumn Is colMessageLocalized Then
        pAlertMessageCol.SortByMessageLocalized()
      ElseIf pNewColumn Is colAction Then
        pAlertMessageCol.SortByAction()
      ElseIf pNewColumn Is colActionLocalized Then
        pAlertMessageCol.SortByActionLocalized()
      End If
      If _PrevSortColumn IsNot Nothing AndAlso _PrevSortColumn IsNot pNewColumn Then 
      Dim iCntr As Integer = 0 
        If pNewColumn Is colID Then
          Dim pTest As Long = 0 
          For Each p As csAlertMessage In pAlertMessageCol 
        ...
        ElseIf pNewColumn Is colNumber Then
          ...
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.Number <> pTest Then iCntr += 1 : pTest = p.Number 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colDescription Then
          Dim pTest As String = "" 
        ...
        ElseIf pNewColumn Is colSeverity Then
          ...
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.Severity <> pTest Then iCntr += 1 : pTest = p.Severity 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colMessage Then
          Dim pTest As String = "" 
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.Message <> pTest Then iCntr += 1 : pTest = p.Message 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colMessageLocalized Then
          Dim pTest As String = "" 
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.MessageLocalized <> pTest Then iCntr += 1 : pTest = p.MessageLocalized 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colAction Then
          Dim pTest As String = "" 
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.Action <> pTest Then iCntr += 1 : pTest = p.Action 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colActionLocalized Then
          Dim pTest As String = "" 
          For Each p As csAlertMessage In pAlertMessageCol 
            If p.ActionLocalized <> pTest Then iCntr += 1 : pTest = p.ActionLocalized 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        End If 
        pAlertMessageCol.SortByTag() 
      End If 
      pNewColumn.HeaderCell.SortGlyphDirection = SortOrder.Ascending
      _PrevSortColumn = pNewColumn
      pPrevSortOrder = SortOrder.Ascending
    Else
      pAlertMessageCol.Reverse()
      pNewColumn.HeaderCell.SortGlyphDirection = SortOrder.Descending
      pPrevSortOrder = SortOrder.Descending
    End If

    If _Summarized = True Then 
      pAlertMessageCol.Add(pSummaryRow) 
    End If 
 
    If pID > 0 Then
      bsCtlAlertMessage.Position = bsCtlAlertMessage.IndexOf(pAlertMessageCol.FindByID(pID))
    End If

    'dgvAlertMessage.AutoResizeRows(DataGridViewAutoSizeRowsMode.AllCells) 
    dgvAlertMessage.ResumeLayout()
  ...
  Public Sub SelectRowByObjectID(ByVal pID As Long) 
    If pID > 0 Then 
      Dim pAlertMessageCol As csAlertMessageCol 
      pAlertMessageCol = CType(bsCtlAlertMessage.DataSource, csAlertMessageCol) 
      Dim pAlertMessage As csAlertMessage = pAlertMessageCol.FindByID(pID) 
      If Not pAlertMessage.IsEmpty Then 
        bsCtlAlertMessage.Position = bsCtlAlertMessage.IndexOf(pAlertMessageCol.FindByID(pID)) 
        dgvAlertMessage.Rows(bsCtlAlertMessage.Position).Selected = True 
      Else 
        dgvAlertMessage.ClearSelection() 
      End If 
    ElseIf pID = 0 Then 
  ...
  'Grid Resize
  Private Sub dgvAlertMessage_ColumnHeaderMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvAlertMessage.ColumnHeaderMouseDoubleClick
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    Cursor = Cursors.WaitCursor
    dgvAlertMessage.AutoResizeColumn(e.ColumnIndex)
    Cursor = Cursors.Default
  End Sub
  'Other Grid Events
  Private Sub dgvAlertMessage_CurrentCellDirtyStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvAlertMessage.CurrentCellDirtyStateChanged
   _DVGDirty = True 
  End Sub
  Private Sub dgvAlertMessage_Scroll(sender As Object, e As ScrollEventArgs) Handles dgvAlertMessage.Scroll
    dgvAlertMessage.Invalidate() 
  End Sub
 
  Private Sub dgvAlertMessage_DataFault(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles dgvAlertMessage.DataError
    'Dim pFault As New clsFault
    '
    'If e.RowIndex = dgvAlertMessage.Rows.Count - 1 Then Exit Sub
 
    'If dgvAlertMessage.Columns(e.ColumnIndex).Name.StartsWith("colIDin", StringComparison.OrdinalIgnoreCase) Then Exit Sub 
    ...
    'Try 
    '  Try 
    '    pSubStrg.AppendLine("In table 'AlertMessage', the row with an ID of " & dgvAlertMessage.Rows(e.RowIndex).Cells(0).Value.ToString)
    '  Catch ex As Exception 
    '    pSubStrg.AppendLine("In grid 'AlertMessage', row index " & e.RowIndex) 
    '  End Try 
    '  Try 
    '    pSubStrg.AppendLine(" has an invalid value of " & dgvAlertMessage.Rows(e.RowIndex).Cells(e.ColumnIndex).Value.ToString)
    '  Catch ex As Exception 
    '    pSubStrg.AppendLine(" has an invalid value of Nothing.") 
    '  End Try 
    '  pSubStrg.AppendLine(" in column " & dgvAlertMessage.Columns(e.ColumnIndex).DataPropertyName) 
    'Catch ex As Exception 
    '  pSubStrg.AppendLine("; Failed trying to fill DataFault as well!") 
    'End Try 
    'pFault.LogException(209, e.Exception, pSubStrg.ToString, "TRGT-AlertMessage-100409-2248", _Requester) 
    'If pShown = False Then 
    '  Dim pCell As DataGridViewCell 
    '  Try 
    '    pCell = dgvAlertMessage(e.ColumnIndex, e.RowIndex)
    '  Catch ex As Exception 
    '    pCell = dgvAlertMessage(0, 0)
    '  End Try 
    '  ShowFault(pFault, _Requester) 
    '  pShown = True 
    'End If 
  End Sub
  Private Sub dgvAlertMessage_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvAlertMessage.KeyDown 
    If e.KeyCode = Keys.Escape Then 
      ...
      End If 
      SetUpBNButtons(False) 
      'dgvAlertMessage.CurrentCell = dgvAlertMessage.Rows(dgvAlertMessage.CurrentCell.RowIndex).Cells(0) 
      dgvAlertMessage.Refresh() 
    End If 
  End Sub 
  Private Sub dgvAlertMessage_ColumnWidthChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles dgvAlertMessage.ColumnWidthChanged
    If Me.DesignMode = True Then Exit Sub 
    If _Loading = False Then SaveSizes()
  End Sub
  Private Sub dgvAlertMessage_ColumnDisplayIndexChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles dgvAlertMessage.ColumnDisplayIndexChanged
    Cursor = Cursors.WaitCursor
    If _Loading = False Then SaveSizes()
    Cursor = Cursors.Default
  End Sub
  Private Sub dgvAlertMessage_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvAlertMessage.CellDoubleClick 
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    If e.RowIndex < 0 Then Exit Sub 
    If _Summarized = True AndAlso e.RowIndex = dgvAlertMessage.Rows.Count - 1 Then Exit Sub 
    Cursor = Cursors.WaitCursor 
    Dim pCell As DataGridViewCell = dgvAlertMessage(e.ColumnIndex, e.RowIndex) 
 
    Dim pHandled As Boolean = False 
    Dim pAlertMessage As csAlertMessage = _AlertMessageCol(e.RowIndex)
    RaiseEvent evtRowDoubleClicked(pAlertMessage, pHandled) 
    Cursor = Cursors.Default 
 
    If pHandled = False Then 
      If Me.ParentForm.Name.Equals("frmPopup", StringComparison.OrdinalIgnoreCase) Then Return 
      frmPopup.Text = "AlertMessage Detail" 
      Dim pFault As clsFault = frmPopup.LoadControl("ctlc_AlertMessage", pAlertMessage, _Requester) 
      If Not pFault.isOK Then ShowFault(pFault, _Requester) : Exit Sub 
      frmPopup.ShowDialog() 
    End If 
 
  End Sub 
  Private Sub dgvAlertMessage_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvAlertMessage.SelectionChanged 
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    ...
    If _Summarized = True AndAlso RowIndex = dgvAlertMessage.Rows.Count - 1 Then dgvAlertMessage.ClearSelection() : RaiseEvent evtUnChosen() : Exit Sub 
    Dim pAlertMessage As csAlertMessage = _AlertMessageCol(RowIndex)
    _ProcessingSelection = True
    Try
      RaiseEvent evtRowClicked(pAlertMessage) 
    Finally
      _IgnoreSelectionUntil = DateTime.Now.AddMilliseconds(500)
      _ProcessingSelection = False
    End Try
  End Sub 
  Private Sub dgvAlertMessage_RowLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvAlertMessage.RowLeave 
    colID.ReadOnly = True 
  End Sub 
  ...
  Private Function UpdateRow() As Boolean 
    ...
    If pOriginalCol > 0 Then 
      ...
      Do Until dgvAlertMessage.Columns(pNewCol).Visible = True OrElse pNewCol = 0 
        pNewCol = pNewCol - 1 
      Loop 
    Else 
      pNewCol = 1 
    End If 
    If dgvAlertMessage.Columns(pNewCol).Visible = False Then 
      dgvAlertMessage.Columns(pNewCol).Visible = True 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.CurrentRow.Cells(pNewCol) 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.CurrentRow.Cells(pOriginalCol) 
      dgvAlertMessage.Columns(pNewCol).Visible = False 
    Else 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.CurrentRow.Cells(pNewCol) 
      dgvAlertMessage.CurrentCell = dgvAlertMessage.CurrentRow.Cells(pOriginalCol) 
    End If 
    ...
    RaiseEvent evtBeforeUpdate(CType(pAlertMessage, csAlertMessage), pCancel) 
    If pCancel = True Then 
      _DVGDirty = False 
      RaiseEvent evtTimerTripped() 
      Return True 
    End If 
    pFault = pAlertMessage.Update(_Requester) 
    ...
    Else 
      If pFault.isOK = False Then 'AndAlso pFault.Severity = clsEnums.enmFaultSeverity.LogOnly  
        ShowFault(pFault, _Requester) 
      End If 
      dgvAlertMessage.EndEdit() 
      _DVGDirty = False 
      'Reset the AlertMessage collection 
      MyCache.ClearComboList(clsEnums.enmComboListType.c_AlertMessageDefaultByID) 
      RaiseEvent evtUpdated(pAlertMessage) 
      Return False 
    End If 
  End Function 
  Private Sub SaveSizes() 
    ...
    For Each pCol As DataGridViewColumn In dgvAlertMessage.Columns 
  ...
  Private Sub Summarize() 
    If _AlertMessageCol.Count <= 1 Then 
      _Summarized = False 
      Exit Sub 
    End If 
 
    Dim pNumber As Integer 
    For Each pExistingRow As csAlertMessage In _AlertMessageCol 
      If _SummaryOverFlow.IndexOf("#Number#") < 0 Then 
        Try 
          pNumber += pExistingRow.Number 
        Catch ex As System.OverflowException 
          pNumber = -99999999 
          _SummaryOverFlow &= "Number#" 
        End Try 
      End If 
    Next 
    If _LoadParameters.DoNotSummarizeProperties.Find(Function(p) p = csAlertMessage.enmSummarizeableProperty.Number) = csAlertMessage.enmSummarizeableProperty.Number Then pNumber = 0
    Dim pSummaryRow As New csAlertMessage( _ 
        vID:=0 _ 
      , vNumber:=pNumber _ 
      , vDescription:="" _ 
      , vType:=clsEnums.enmFaultType.UD _ 
      , vTypeText:="" _ 
      , vSeverity:=clsEnums.enmFaultSeverity.UD _ 
      , vSeverityText:="" _ 
      , vMessage:="" _ 
      , vMessageLocalized:="" _ 
      , vAction:="" _ 
    ...
    _AlertMessageCol.Add(pSummaryRow) 
    _Summarized = True 
  End Sub 
  ...
  Friend Function CreateSpreadSheet() As clsFault  
    ...
    Dim pFileNameAllFields As String = $"{pRoot}\AlertMessageCol_{pDateToShow}AllFields.csv" 
    Dim pFileNameFieldsOnGrid As String = $"{pRoot}\AlertMessageCol_{pDateToShow}FieldsOnGrid.csv" 
    Dim pFileNameAllFieldsWithIDs As String = $"{pRoot}\AlertMessageCol_{pDateToShow}AllFieldsWithIDs.csv" 
    Dim pFileNameAllFieldsXML As String = $"{pRoot}\AlertMessageCol_{pDateToShow}AllFields.xml" 
    Dim pFileNameAllFieldsJson As String = $"{pRoot}\AlertMessageCol_{pDateToShow}AllFields.json" 
    ...
    For Each Row As DataGridViewRow In dgvAlertMessage.Rows 
      i += 1 
      If _LoadParameters.SummarizeGrid = True Then 
        If Row.Index = dgvAlertMessage.Rows.Count - 1 Then Exit For 
      End If 
      If i Mod 500 = 0 Then 
    ...
    Try  
      If pShowAllFields = True Then  
        Dim pStrg As String = "" 
        'xml 
        pFault = _AlertMessageColFullLength.CreateXML(pStrg, _Requester) : If pFault.isOK = False Then Return pFault 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsXML, pStrg, False) 
        'json 
        pFault = _AlertMessageColFullLength.CreateJSON(pStrg, _Requester) : If pFault.isOK = False Then Return pFault 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsJson, pStrg, False) 
        'default  
        My.Computer.FileSystem.WriteAllText(pFileNameAllFields, _AlertMessageColFullLength.ToCSV, False)  
        'WithIDs  
        'pFault = _AlertMessageColFullLength.LoadLookupAndEnumText(_Requester) : If pFault.isOK = False Then Return pFault (already done) 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsWithIDs, _AlertMessageColFullLength.ToCSV(True), False) 
      End If  
      'default  
      My.Computer.FileSystem.WriteAllText(pFileNameFieldsOnGrid, pCSV.ToString, False)  
      pFault.SetOK()  
    Catch ex As Exception  
      pFault.LogException(ex, "", "TRGT-AlertMessage-090210-1618", _Requester)  
    End Try  
    If pFault.isOK = False Then Return pFault  
  ...
  Private Sub ReportDesign() 
    ...
    Try 
      ...
      With _Report 
        ...
        .SubTitleLeft = "AlertMessages" 
        .SubTitleRight = "Rows: " & _AlertMessageCol.Count.ToString 
        ...
        End If 
        .DataSource = _AlertMessageCol 
        .HasSummaryLine = _Summarized 
      End With 
    Catch ex As Exception 
      Dim pFault As New clsFault 
      pFault.LogException(ex, "", "TRGT-AlertMessage-090210-2119", _Requester) : ShowFault(pFault, _Requester) : Exit Sub 
    End Try 
  End Sub 
  Friend Function CreateReport() As clsFault 
    ...
    Catch ex As Exception 
      pFault = New clsFault 
      pFault.LogException(ex, "", "TRGT-AlertMessage-090211-0746", _Requester) 
    End Try 
    Return pFault 
  End Function 
  ...
  Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged 
    ...
    If String.IsNullOrEmpty(pSearchText) Then 
      For Each pRow As DataGridViewRow In dgvAlertMessage.Rows 
    ...
    For Each row As DataGridViewRow In dgvAlertMessage.Rows 
      ...
      Next 
      Try 
        Dim pBS As CurrencyManager = CType(Me.BindingContext(bsCtlAlertMessage), CurrencyManager) 
    ...
    lblStatus.Text = pVisibleCount & " of " & dgvAlertMessage.RowCount & " rows" 
  End Sub 
  ...
  Private Function GetOrInitializeGridSettings() As clsFault 
    ...
    Catch ex As Exception 
      pFault.LogException(ex, "GetOrInitializeGridSettings", "TRGT-AlertMessage-120225-1310", _Requester) 
    End Try 
    If pFault.isOK = False Then Return pFault 
    ...
    Else 
      ...
      For Each pCol As DataGridViewColumn In dgvAlertMessage.Columns 
        ...
        If pG.ColumnName = "" Then 
          pG.ColumnDisplayIndex = pCol.DisplayIndex 
          pG.ColumnWidth = ccHelper.ToInteger((dgvAlertMessage.Width - 30) / dgvAlertMessage.Columns.Count) 
  ...
  Private Sub LoadColumns() 
    ...
    'colAction.DefaultCellStyle.WrapMode = DataGridViewTriState.True 
    ...
    Try 
      For Each lGridSetting In _GridSettings 
        Try 
          ...
          With dgvAlertMessage.Columns(lGridSetting.ColumnName) 
    ...
    Catch ex As Exception 'Fault in getting GridSettings  
      pFault.LogException(204, ex, "", "TRGT-AlertMessage-090120-1502", _Requester) : ShowFault(pFault, _Requester) : Exit Sub 
    End Try 
  End Sub 
  ...
  Private Sub LoadLocalizedText() 
    ...
    If pStrg <> "" Then colNumber.HeaderText = pStrg : mnuColVisibleNumber.Text = pStrg
    ...
    If pStrg <> "" Then colSeverity.HeaderText = pStrg : mnuColVisibleSeverity.Text = pStrg
 
    pStrg = ccHelper.GetLocalizedFieldName("c_AlertMessage", "Message", _Requester) 
    If pStrg <> "" Then colMessageLocalized.HeaderText = pStrg : mnuColVisibleMessageLocalized.Text = pStrg
 
    pStrg = ccHelper.GetLocalizedFieldName("c_AlertMessage", "Action", _Requester) 
    If pStrg <> "" Then colActionLocalized.HeaderText = pStrg : mnuColVisibleActionLocalized.Text = pStrg
  ...
  Private Sub mnuColVisible_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColVisibleID.Click, mnuColVisibleNumber.Click, mnuColVisibleDescription.Click, mnuColVisibleType.Click, mnuColVisibleSeverity.Click, mnuColVisibleMessage.Click, mnuColVisibleMessageLocalized.Click, mnuColVisibleAction.Click, mnuColVisibleActionLocalized.Click
    Cursor = Cursors.WaitCursor 
    Dim pToolStripItem As System.Windows.Forms.ToolStripMenuItem = CType(sender, System.Windows.Forms.ToolStripMenuItem) 
    dgvAlertMessage.Columns("col" & pToolStripItem.Name.Substring(13)).Visible = pToolStripItem.Checked 
    If _Loading = False Then SaveSizes() 
    Cursor = Cursors.Default 
  End Sub 
  Private Sub mnuColsReset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColsReset.Click 
    ...
    pNewWidth = ccHelper.ToInteger((dgvAlertMessage.Width - 30) / pVisibleColumns) 
  ...
  Private Sub mnuColsHideMost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColsHideMost.Click 
    ...
    If mnuColVisibleNumber.Checked = True Then mnuColVisibleNumber.PerformClick() 
    ...
    If mnuColVisibleSeverity.Checked = True Then mnuColVisibleSeverity.PerformClick() 
    If mnuColVisibleMessage.Checked = True Then mnuColVisibleMessage.PerformClick() 
    If mnuColVisibleMessageLocalized.Checked = True Then mnuColVisibleMessageLocalized.PerformClick() 
    If mnuColVisibleAction.Checked = True Then mnuColVisibleAction.PerformClick() 
    If mnuColVisibleActionLocalized.Checked = True Then mnuColVisibleActionLocalized.PerformClick() 
    'Show Defaults 
    If mnuColVisibleNumber.Checked = False Then mnuColVisibleNumber.PerformClick() 
    
    _Loading = False 
    'dgvAlertMessage.AutoResizeRows(DataGridViewAutoSizeRowsMode.AllCells) 
  End Sub 
  
  Private Sub dgvAlertMessage_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvAlertMessage.CellMouseClick 
    If e.Button = MouseButtons.Right Then 
      Dim pMessageBox As frmMessageOrInputBox.enmButtonReturned = frmMessageOrInputBox.ShowMsg("How do you want to copy the AlertMessage to the clipboard?", frmMessageOrInputBox.enmIconType.QuestionMark, frmMessageOrInputBox.enmButtons.YesNoCancel, vYesText:="Text", vNoText:="CSV") 
  ...
  Private Sub dgvAlertMessage_MouseDown(sender As Object, e As MouseEventArgs) Handles dgvAlertMessage.MouseDown 
    '--- Save anchor on normal click (no modifiers) ---
    Dim pModifiers = Control.ModifierKeys 
    If (pModifiers And (Keys.Shift Or Keys.Control)) = 0 AndAlso dgvAlertMessage.CurrentRow IsNot Nothing Then 
      _SelectionAnchor = dgvAlertMessage.CurrentRow.Index 
    End If 
    'This removes on click from the update 
    If dgvAlertMessage.EditMode = DataGridViewEditMode.EditProgrammatically Then Exit Sub 
 
    Dim pCell As DataGridView.HitTestInfo = dgvAlertMessage.HitTest(e.X, e.Y) 
    ...
    If pCell.Type = DataGridViewHitTestType.Cell Then 
      ...
      Try 
        pCurrentCell = dgvAlertMessage(pCell.ColumnIndex, pCell.RowIndex) 
        If pCurrentCell.ReadOnly Then Exit Sub 
        dgvAlertMessage.CurrentCell = pCurrentCell 
      Catch ex As Exception 
        Exit Sub  
      End Try 
      ...
      If pCurrentCell.GetType().Name.Equals("DataGridViewComboBoxCell", StringComparison.OrdinalIgnoreCase) Then 
        dgvAlertMessage.BeginEdit(True) 
        DirectCast(dgvAlertMessage.EditingControl, DataGridViewComboBoxEditingControl).DroppedDown = True 
      End If 
    End If 
  End Sub 
 
  Private Sub dgvAlertMessage_MouseUp(sender As Object, e As MouseEventArgs) Handles dgvAlertMessage.MouseUp 
    Dim pModifiers = Control.ModifierKeys 
    If (pModifiers And Keys.Shift) = Keys.Shift AndAlso _SelectionAnchor >= 0 Then 
      Dim hit = dgvAlertMessage.HitTest(e.X, e.Y) 
      If hit.RowIndex >= 0 Then 
        dgvAlertMessage.MultiSelect = True 
        dgvAlertMessage.ClearSelection() 
        ...
        For i As Integer = pFrom To pTo 
          dgvAlertMessage.Rows(i).Selected = True 
        Next 
      End If 
    ElseIf (pModifiers And Keys.Control) = Keys.Control Then 
      dgvAlertMessage.MultiSelect = True 
    Else 
      dgvAlertMessage.MultiSelect = False 
    End If 
  End Sub 
  ...
  Private Sub ctlc_AlertMessageCol_FontChanged(sender As Object, e As EventArgs) Handles Me.FontChanged 
    'Set the font for the BN 
        If MyFont Is Nothing Then Return 
    BN.Font = New Font(MyFont.Name, MyFont.Size) 
    dgvAlertMessage.RowTemplate.Height = ccHelper.ToInteger(23 * MyFont.Size / 9) 
  End Sub 
 
  Private Sub ctlc_AlertMessageCol_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged 
    If Me.ParentForm Is Nothing Then Exit Sub 
    Dim pParent As String = Me.ParentForm.Name 
    Dim pResponse As Boolean = Me.Visible 
    Dim pSize As Integer = dgvAlertMessage.Width 
  ...
  Private Sub ctlc_AlertMessageCol_VisibleChanged(sender As Object, e As EventArgs) Handles Me.VisibleChanged 
  ...
  Private Sub ctlc_AlertMessageCol_Leave(sender As Object, e As EventArgs) Handles Me.Leave 
  ...
  Private Sub dgvAlertMessage_CellMouseDown(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvAlertMessage.CellMouseDown 
    ReleaseStuckModifierKeys() 'Fix sticky SHIFT/CTRL before selection changes 
    If e.Button = MouseButtons.Right AndAlso e.RowIndex >= 0 Then 
      If Not dgvAlertMessage.Rows(e.RowIndex).Selected Then 
        dgvAlertMessage.ClearSelection() 
        dgvAlertMessage.Rows(e.RowIndex).Selected = True 
      End If 
    End If 
  End Sub 
  ...
  Private Sub cmsGrid_Opening(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles cmsGrid.Opening 
    Dim pCount As Integer = dgvAlertMessage.SelectedRows.Count 
  ...
  Private Sub tsmiOpenDetail_Click(sender As Object, e As EventArgs) Handles tsmiOpenDetail.Click 
    If dgvAlertMessage.SelectedRows.Count <> 1 Then Exit Sub 
    Dim pRowIndex As Integer = dgvAlertMessage.SelectedRows(0).Index 
    If pRowIndex < 0 OrElse pRowIndex >= _AlertMessageCol.Count Then Exit Sub 
    Dim pAlertMessage As csAlertMessage = _AlertMessageCol(pRowIndex) 
    Dim pTitle As String = "AlertMessage #" & pAlertMessage.ID.ToString() 
    Dim pKey As String = "AlertMessage_" & pAlertMessage.ID.ToString() 
    ...
    Dim pCtlName As String = "ctlc_AlertMessage" 
    ...
    Dim pFault As clsFault = CType(pLoad.Invoke(pControl, New Object() {pAlertMessage, _Requester}), clsFault) 
    If Not pFault.isOK Then ShowFault(pFault, _Requester) : Exit Sub 
    'Return to Tab click handler - sends entity to a new tab in frmMain 
    Dim pEntityRef As Object = pAlertMessage 
  ...
  Private Sub tsmiOpenInTab_Click(sender As Object, e As EventArgs) Handles tsmiOpenInTab.Click 
    ...
    Dim pWinKey As String = "AlertMessage_" & pAlertMessage.ID.ToString() 
    If _openDetailWindows.ContainsKey(pWinKey) Then 
      ...
      End If 
    End If 
    Dim pTabTitle As String = "AlertMessage #" & pAlertMessage.ID.ToString() 
    Dim pFault As clsFault = pFrmMain.OpenEntityInNewTab("ctlc_AlertMessage", pAlertMessage, _Requester, pTabTitle) 
  ...
  Private Sub tsmiCopyID_Click(sender As Object, e As EventArgs) Handles tsmiCopyID.Click 
    If dgvAlertMessage.SelectedRows.Count = 0 Then Exit Sub 
    Dim pIDs As New System.Text.StringBuilder() 
    For Each pSelectedRow As DataGridViewRow In dgvAlertMessage.SelectedRows 
      If pSelectedRow.Index >= 0 AndAlso pSelectedRow.Index < _AlertMessageCol.Count Then 
        Dim pAlertMessage As csAlertMessage = _AlertMessageCol(pSelectedRow.Index) 
        If pIDs.Length > 0 Then pIDs.Append(", ") 
        pIDs.Append(pAlertMessage.ID.ToString()) 
      End If 
    Next 
  ...
  Private Sub tsmiCopyRowHeaders_Click(sender As Object, e As EventArgs) Handles tsmiCopyRowHeaders.Click 
    ...
    Dim pFirstRow As DataGridViewRow = dgvAlertMessage.SelectedRows(0) 
