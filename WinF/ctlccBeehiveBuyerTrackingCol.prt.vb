Partial Public Class ctlccBeehiveBuyerTrackingCol
  ...
  Private Sub ctlccBeehiveBuyerTrackingCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsBeehiveBuyerTracking.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsBeehiveBuyerTracking.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccBeehiveBuyerTrackingCol_evtLoaded() Handles Me.evtLoaded 
