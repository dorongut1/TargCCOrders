Partial Public Class ctlccProductPriceCol
  ...
  Private Sub ctlccProductPriceCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsProductPrice.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsProductPrice.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccProductPriceCol_evtLoaded() Handles Me.evtLoaded 
