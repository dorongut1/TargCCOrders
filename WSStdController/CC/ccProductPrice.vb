Public Class clsProductPrice
  ...
  Public Function GetByID(ByVal vID As Long, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceGetByID" 
      ...
      'Use the response to build the ProductPrice 
      LoadByteArray(pResponse, pFault, vRequester) : If Not pFault.isOK Then Return pFault 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-150308-1015", vRequester) 
    End Try 
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault
    ...
    If Me.isEqual(pProductPrice) Then 
      Return pFault.LogFreeTextFault(53, "Object is 'New' - contains no data ", "", "TRGT-ProductPrice-100113-1813", vRequester) 
    End If 
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceUpdate" 
      ...
      End If 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-150314-1803", vRequester) 
    End Try 
  ...
  Public Function Delete(ByVal vRequester As clsRequester) As clsFault Implements ITargCCEntityDeletable.Delete 
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceDelete" 
      Dim pParametersToLog = $"ID: {ID}" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Shared Function DeleteByID(vID As Long, vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      'Run the request  
      Dim pFunction As String = "clsProductPriceDeleteByID" 
      Dim pParametersToLog = $"ID: {vID}" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
 
      'Assign the value  
    Catch ex As Exception 
      Return New clsFault().LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-231207-1707", vRequester) 
    End Try 
...
          'bDateAdded 
  ...
  Public Function LoadParents(ByVal vRequester As clsRequester) As clsFault
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceLoadParents" 
      ...
      LoadByteArray(pResponse, pFault, vRequester) : If Not pFault.isOK Then Return pFault 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-150411-1107", vRequester) 
    End Try 
...
Public Class clsProductPriceCol
  ...
  Public Overrides Function Fill(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColFill" 
  ...
  ''' <summary>
  ''' Gets a collection of all the items for a specific ProductID and CustomerType, or a sub-collection defined by HowMany and Direction. To append to an existing collection, set vAppend to true (default is false)
  ''' </summary>
  ''' <param name="vHowMany">How Many (sorted by ID) - 0 for all</param>
  ''' <param name="vDir">ASCendined or DESCending</param>
    ...
    Try 
      ...
      Using pMemoryStream As New System.IO.MemoryStream() 
        Using pBinaryWriter As New System.IO.BinaryWriter(pMemoryStream, Text.Encoding.UTF8) 
          ...
          ' 
          'vCustomerType 
          pBinaryWriter.Write(vCustomerType.ToString()) 
          ' 
          pBinaryWriter.Write(vHowMany) 
          pBinaryWriter.Write(vDir.FastToString()) 
      ...
      Dim pFunction As String = "clsProductPriceColFillByProductIDAndCustomerType" 
      Dim pParametersToLog = $"ProductIDAndCustomerType: {vProductID};{vCustomerType};" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
 
      'Use the response to build the ProductPrice  
      If vAppend = True Then 
        Dim pProductPrices As New clsProductPriceCol 
        pProductPrices.LoadByteArray(pResponse, pFault, vRequester) : If Not pFault.isOK Then Return pFault 
        Me.AddRange(pProductPrices) 
      Else 
        LoadByteArray(pResponse, pFault, vRequester) : If Not pFault.isOK Then Return pFault 
      End If 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-150407-2142", vRequester) 
    End Try 
  ...
  Public Function FillByProductID(ByVal vProductID As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColFillByProductID" 
  ...
  Public Function FillByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColFillByBoundedID" 
  ...
  Public Function FillByListOfID(vIDs As List(Of Long), vRequester As clsRequester, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault 
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColFillByListOfID" 
      ...
      End If 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-231207-1750", vRequester) 
    End Try 
    ...
    Try 
      ...
      Using pMemoryStream As New System.IO.MemoryStream() 
        Using pBinaryWriter As New System.IO.BinaryWriter(pMemoryStream, Text.Encoding.UTF8) 
          ...
          'CustomerType 
          pBinaryWriter.Write(vCustomerType.ToString()) : pParametersToLog &= $"CustomerType={vCustomerType};"  
          pBinaryWriter.Write(vHowMany) 
          pBinaryWriter.Write(vDir.FastToString()) 
          pBinaryWriter.Write(_WithParents.ToString()) 
          pBinaryWriter.Close() 
      ...
      Dim pFunction As String = "clsProductPriceColFillOnTheFly" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
    ...
    Try 
      ...
      Using pMemoryStream As New System.IO.MemoryStream() 
        Using pBinaryWriter As New System.IO.BinaryWriter(pMemoryStream, Text.Encoding.UTF8) 
          ...
          pBinaryWriter.Write(vGroupByCustomerType) : pParametersToLog &= $"GroupByCustomerType={vGroupByCustomerType};"  
          pBinaryWriter.Write(_WithParents.ToString()) 
          pBinaryWriter.Close() 
        End Using 
        pRequest = pMemoryStream.ToArray() 
      ...
      Dim pFunction As String = "clsProductPriceColFillSumOnTheFly" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.Update 
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceColUpdate" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, "Parameters: None", pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Function UpdateFromCollection(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.UpdateFromCollection 
    ...
    Try 
      ...
      'Run the request 
      Dim pFunction As String = "clsProductPriceColUpdateFromCollection" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, "Parameters: None", pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Shared Function Delete(ByVal vRequester As clsRequester) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColDelete" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, "Parameters: None", pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
 
    Catch ex As Exception 
      Return pFault.LogException(73, ex, pFunctionParameters, "TRGT-ProductPrice-200709-0852-", vRequester) 
    End Try 
  ...
  Public Shared Function DeleteByProductIDAndCustomerType(ByVal vProductID As Long, ByVal vCustomerType As clsEnums.enmCustomerType, ByVal vRequester As clsRequester) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColDeleteByProductIDAndCustomerType" 
      Dim pParametersToLog = $"ProductIDAndCustomerType: {vProductID};{vCustomerType};" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Shared Function DeleteByProductID(ByVal vProductID As Long, ByVal vRequester As clsRequester) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColDeleteByProductID" 
      Dim pParametersToLog = $"ProductID: {vProductID};" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
  ...
  Public Shared Function DeleteByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester) As clsFault
    ...
    Try 
      ...
      Dim pFunction As String = "clsProductPriceColDeleteByBoundedID" 
      Dim pParametersToLog = $"ID: {vIDFrom};{vIDTo};" 
      pFault = WebAPI.RunAPI(pFunction, pRequest, pParametersToLog, pResponse, vRequester) : If Not pFault.isOK Then Return pFault 
