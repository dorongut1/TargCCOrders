Partial Public Class ctlc_MailCol
  ...
  Private Sub ctlc_MailCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csMail.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csMail.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_MailCol_evtLoaded() Handles Me.evtLoaded 
