Partial Public Class ctlc_JobCol
  ...
  Private Sub ctlc_JobCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    '_LoadParameters.ColumnsHeaderText.Add(csJob.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_JobCol_evtLoaded() Handles Me.evtLoaded 
