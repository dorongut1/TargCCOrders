Partial Public Class ctlc_TableCol
  ...
  Private Sub ctlc_TableCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csTable.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csTable.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_TableCol_evtLoaded() Handles Me.evtLoaded 
