Partial Public Class ctlccProductPriceHistCol
  ...
  Private Sub ctlccProductPriceHistCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsProductPriceHist.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsProductPriceHist.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccProductPriceHistCol_evtLoaded() Handles Me.evtLoaded 
