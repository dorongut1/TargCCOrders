Partial Public Class ctlc_LoggedRequestCol
  ...
  Private Sub ctlc_LoggedRequestCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLoggedRequest.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLoggedRequest.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LoggedRequestCol_evtLoaded() Handles Me.evtLoaded 
