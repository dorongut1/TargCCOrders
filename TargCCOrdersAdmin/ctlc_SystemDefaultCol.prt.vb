Partial Public Class ctlc_SystemDefaultCol
  ...
  Private Sub ctlc_SystemDefaultCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    '_LoadParameters.ColumnsHeaderText.Add(csSystemDefault.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_SystemDefaultCol_evtLoaded() Handles Me.evtLoaded 
