Public Class ctlc_ObjectToTranslateCol
  ...
  Public Event evtUpdated(ByVal vObjectToTranslate As csObjectToTranslate) 
  Private Event evtBeforeDelete(ByVal vObjectToTranslate As csObjectToTranslate, ByRef rCancel As Nullable(Of Boolean)) 
  
  Public Event evtRowClicked(ByVal vObjectToTranslate As csObjectToTranslate) 
  Public Event evtRowDoubleClicked(ByVal vObjectToTranslate As csObjectToTranslate, ByRef rHandled As Boolean) 
  Public Event evtUnChosen() 
 
  Public Event evtOverrideLoadCbo(ByVal vParentName As csObjectToTranslate.enmParentProperty, ByRef rComboListTypeToLoad As clsEnums.enmComboListType, ByRef rParentID As Long, ByRef rComboList As clsComboList, ByRef rPrompt As String) 
  ...
  Public Class clsLoadParameters 
    ...
    Public Property CbosDoNotLoad As List(Of csObjectToTranslate.enmParentProperty) 
    Public Property ColumnsReadOnly As List(Of csObjectToTranslate.enmProperty) 
    Public Property ColumnsHide As List(Of csObjectToTranslate.enmProperty) 
    Public Property ColumnsFormat As Dictionary(Of csObjectToTranslate.enmProperty, String) 
    Public Property ColumnsOrdinalPosition As Dictionary(Of csObjectToTranslate.enmProperty, Integer) 
    Public Property ColumnsAlignment As Dictionary(Of csObjectToTranslate.enmProperty, DataGridViewContentAlignment) 
    Public Property ColumnsHeaderText As Dictionary(Of csObjectToTranslate.enmProperty, String) 
    ...
    Public Sub New() 
      ...
      _ReportTitle = "" 
      _ReadOnly = False 
      _CbosDoNotLoad = New List(Of csObjectToTranslate.enmParentProperty) 
      _ColumnsReadOnly = New List(Of csObjectToTranslate.enmProperty) 
      _ColumnsHide = New List(Of csObjectToTranslate.enmProperty) 
      _ColumnsFormat = New Dictionary(Of csObjectToTranslate.enmProperty, String) 
      _ColumnsOrdinalPosition = New Dictionary(Of csObjectToTranslate.enmProperty, Integer) 
      _ColumnsAlignment = New Dictionary(Of csObjectToTranslate.enmProperty, DataGridViewContentAlignment) 
      _ColumnsHeaderText = New Dictionary(Of csObjectToTranslate.enmProperty, String) 
  ...
  Private WithEvents _ObjectToTranslateCol As csObjectToTranslateCol
  Private WithEvents _ObjectToTranslateColFullLength As csObjectToTranslateCol
  ...
  'Properties 
  Public ReadOnly Property [SelectedObjectToTranslate]() As csObjectToTranslate 
    Get 
      If dgvObjectToTranslate.SelectedRows.Count = 0 OrElse _Loading = True Then Return Nothing 
      Dim RowIndex As Integer = dgvObjectToTranslate.SelectedRows(0).Cells(0).RowIndex 
      If RowIndex < 0 Then Return Nothing 
      If _Summarized = True AndAlso RowIndex = dgvObjectToTranslate.Rows.Count - 1 Then dgvObjectToTranslate.ClearSelection() : RaiseEvent evtUnChosen() : Return Nothing 
      Return _ObjectToTranslateCol(RowIndex) 
    End Get 
  End Property 
  
  Public ReadOnly Property [ObjectToTranslateCol]() As csObjectToTranslateCol 
    Get 
      Return _ObjectToTranslateCol 
    End Get 
  End Property 
  ...
  Public Function LoadControl(ByVal vLoadParameters As clsLoadParameters, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = pObjectToTranslateCol.Fill(_Requester) 
    If pFault.isOK = False Then Return pFault 
 
    pFault = LoadControl(pObjectToTranslateCol)
    Return pFault 
  End Function 
 
  Public Function LoadControl(vObjectToTranslateCol As csObjectToTranslateCol, ByVal vLoadParameters As clsLoadParameters, ByVal vRequester As clsRequester) As clsFault
 
    _Requester = vRequester 
    _LoadParameters = vLoadParameters 
 
    Return LoadControl(vObjectToTranslateCol) 
  End Function
  
  Private Function LoadControl(vObjectToTranslateCol As csObjectToTranslateCol) As clsFault
    ...
    'keep safe in case 
    Dim pColumnsHides As List(Of csObjectToTranslate.enmProperty) = Nothing 
    If _LoadParameters.IsSumFillOnTheFly Then 
      pColumnsHides = New List(Of csObjectToTranslate.enmProperty) 
    ...
    For Each l In _LoadParameters.ColumnsReadOnly 
      If l = csObjectToTranslate.enmProperty.ID Then colID.ReadOnly = True 
      If l = csObjectToTranslate.enmProperty.ObjectType Then colObjectType.ReadOnly = True 
      If l = csObjectToTranslate.enmProperty.Object Then colObject.ReadOnly = True 
      If l = csObjectToTranslate.enmProperty.Item Then colItem.ReadOnly = True 
    Next 
    ...
    dgvObjectToTranslate.DoubleBuffered(True) 
 
    pFault = vObjectToTranslateCol.LoadLookupAndEnumText(_Requester) : If Not pFault.isOK Then Return pFault 
    
    'Now transfer to local collection 
    _ObjectToTranslateColFullLength = vObjectToTranslateCol.Clone() 
 
    'Truncate the strings 
    _ObjectToTranslateCol = vObjectToTranslateCol 
    If _LoadParameters.TruncateStrings Then 
      _ObjectToTranslateCol.TruncateStrings() 
    Else 
      dgvObjectToTranslate.DefaultCellStyle.WrapMode = DataGridViewTriState.True 
      dgvObjectToTranslate.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCellsExceptHeaders 
    End If 
    ...
    Next 
    For Each lCol As DataGridViewColumn In dgvObjectToTranslate.Columns 
    ...
    'Hide columns  
    For Each p As csObjectToTranslate.enmProperty In _LoadParameters.ColumnsHide 
    ...
    For Each pD In _LoadParameters.ColumnsHeaderText 
      dgvObjectToTranslate.Columns("col" & pD.Key.ToString).HeaderText = pD.Value 
    Next 
 
    'Format Columns 
    For Each pD In _LoadParameters.ColumnsFormat 
      dgvObjectToTranslate.Columns("col" & pD.Key.ToString).DefaultCellStyle.Format = pD.Value 
    Next 
 
    'ordinal position 
    For Each pD In _LoadParameters.ColumnsOrdinalPosition 
      dgvObjectToTranslate.Columns("col" & pD.Key.ToString).DisplayIndex = pD.Value 
    Next 
    _GridSettings.Update(Me, _Requester)
    
    'Align Columns 
    For Each pD In _LoadParameters.ColumnsAlignment 
      dgvObjectToTranslate.Columns("col" & pD.Key.ToString).DefaultCellStyle.Alignment = pD.Value 
    Next 
    ...
    dgvObjectToTranslate.ClearSelection()
    bsCtlObjectToTranslate.DataSource = Nothing 
    ...
    Catch ex As Exception
      Return pFault.LogException(ex, "LoadGrid", "TRGT-ObjectToTranslate-090124-2345", _Requester) 
    End Try
    ...
    lblStatus.Text = dgvObjectToTranslate.RowCount & " rows" 
    ...
    If _SortList IsNot Nothing Then 
      ...
      For Each i In _SortList 
        ...
        dgvObjectToTranslate_ColumnHeaderMouseClick(Me, pE) 
      Next 
      _AutoSorting = False 
    End If 
  ...
  Private Sub LoadGrid()
    ...
    If dgvObjectToTranslate.SelectedRows.Count > 0 Then 
      pRowIndex = dgvObjectToTranslate.SelectedRows(0).Cells(0).RowIndex 
    Else 
      If dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
        pRowIndex = dgvObjectToTranslate.CurrentCellAddress.Y 
      End If 
    End If 
    ...
    bsCtlObjectToTranslate.DataSource = Nothing 
    bsCtlObjectToTranslate.DataSource = _ObjectToTranslateCol
    ...
    For Each p As ToolStripMenuItem In btnColumns.DropDownItems 
      ...
      p.Checked = dgvObjectToTranslate.Columns("col" & pMenuItemProprty).Visible 
    Next 
 
    If pRowIndex >= 0 Then 
      If _Summarized = True Then 
        If pRowIndex <= _ObjectToTranslateCol.Count - 2 Then 
          dgvObjectToTranslate.Rows(pRowIndex).Selected = True 
        End If 
      Else 
        If pRowIndex <= _ObjectToTranslateCol.Count - 1 Then 
          dgvObjectToTranslate.Rows(pRowIndex).Selected = True 
        End If 
      End If 
    End If 
  ...
  Private Function LoadSupportingCombos() As clsFault
    ...
    pPrompt = "" 
    pEnumCol = Nothing 
    RaiseEvent evtOverrideLoadCbo(csObjectToTranslate.enmParentProperty.ObjectType, Nothing, Nothing, pEnumCol, pPrompt) 
    If pEnumCol Is Nothing Then 
      pEnumCol = New clsComboList 
      pFault = pEnumCol.FillEnums(clsEnums.enmEnum.ObjectType, _Requester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      pFault.SetOK() 
    End If 
    pEnumCol.Remove(pEnumCol.FindByKey(clsEnums.enmObjectType.UD)) 
    pEnumCol.SortByText() 
    If pPrompt = "" Then 
      pPrompt = pChoose 
    End If 
    pEnumCol.AddToTop(clsEnums.enmObjectType.UD, pPrompt) 
    bsObjectType.DataSource = pEnumCol 
    colObjectType.Tag = pPrompt 
  ...
  Private Sub SetUpBNButtons(ByVal vInEdit As Boolean)
    ...
    Else 
      ...
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_ObjectToTranslateUpdate, _Requester) = True AndAlso _LoadParameters.ImportButtonHide = False Then btnImport.Visible = vInEdit Else btnImport.Visible = False 
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_ObjectToTranslateUpdate, _Requester) = True Then btnAdd.Visible = vInEdit Else btnAdd.Visible = False 
      If ccSecurity.GetPermissionForUI(clsEnums.enmProcess.tbl_c_ObjectToTranslateDelete, _Requester) = True Then btnDelete.Visible = vInEdit Else btnDelete.Visible = False 
    ...
    If vInEdit = True AndAlso _LoadParameters.AddEditDeleteButtonsHide = False Then 
      colID.ReadOnly = True 
      dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 
      dgvObjectToTranslate.SelectionMode = DataGridViewSelectionMode.CellSelect 
      _DVGDirty = False 
    Else 
      dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditProgrammatically 
      dgvObjectToTranslate.SelectionMode = DataGridViewSelectionMode.FullRowSelect 
      dgvObjectToTranslate.AllowUserToDeleteRows = False 
      dgvObjectToTranslate.AllowUserToAddRows = False 
      'Don't automatically set the 1st one If dgvObjectToTranslate.Rows.Count > 0 Then 
      '  Dim pCurrentRow As Integer 
      '  pCurrentRow = dgvObjectToTranslate.CurrentRow.Index 
      '  dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(pCurrentRow).Cells(0) 
      '  dgvObjectToTranslate.Rows(pCurrentRow).Selected = True 
      'End If 
    End If 
    ...
    Else 
      If _ObjectToTranslateCol.Count = 0 Then 
        btnSpreadsheet.Enabled = False 
        btnReport.Enabled = False 
      Else 
  ...
  Private Sub btnImport_Click(sender As Object, e As EventArgs) Handles btnImport.Click 
    ...
    pFieldList.Append("ObjectType (DB Code), ") 
    pFieldList.Append("Object, ") 
    pFieldList.Append("Item, ") 
    ...
    'Now Load the data 
    Dim pIncomingObjectToTranslates As New csObjectToTranslateCol() 
    ...
    Using pReader As New Microsoft.VisualBasic.FileIO.TextFieldParser(ofd.FileName, System.Text.Encoding.Unicode) 
      ...
      While Not pReader.EndOfData 
        ...
        Try 
          Dim pIncomingObjectToTranslate As New csObjectToTranslate() 
          pIncomingObjectToTranslate.Tag = "Row " & pRow.ToString 
          ...
          If pCurrentRow.Length <> pNumberOfFields Then 
            pErrorFound = True 
            pIncomingObjectToTranslate.Tag &= ": There should be " & pNumberOfFields & " fields, but there are actually " & pCurrentRow.Length & " fields." 
            pIncomingObjectToTranslates.Add(pIncomingObjectToTranslate) 
            Continue While 
          End If 
          ...
          If pNoPrimaryKey = False Then 
            Try 
              pFieldNo += 1 
              pFieldName = "ID" 
              pIncomingObjectToTranslate.ID = CType(pCurrentRow(pFieldNo), Long) 
            Catch ex As Exception 
              pErrorFound = True 
              pIncomingObjectToTranslate.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
            End Try 
          End If 
 
          Try 
            pFieldNo += 1 
            pFieldName = "ObjectType" 
            pIncomingObjectToTranslate.ObjectType = clsEnums.TranslateEnmObjectType(pCurrentRow(pFieldNo)) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingObjectToTranslate.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Object" 
            pIncomingObjectToTranslate.Object = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingObjectToTranslate.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
          ...
          Try 
            pFieldNo += 1 
            pFieldName = "Item" 
            pIncomingObjectToTranslate.Item = CType(pCurrentRow(pFieldNo), String) 
          Catch ex As Exception 
            pErrorFound = True 
            pIncomingObjectToTranslate.Tag &= ccHelper.NewLine & "Field: " & pFieldName & "; Value: " & pCurrentRow(pFieldNo) & "; Problem: " & ex.Message 
          End Try 
 
          If pIncomingObjectToTranslate.Tag = "Row " & pRow.ToString Then 
            pIncomingObjectToTranslate.Tag &= ": OK" 
          End If 
      ...
      If pErrorFound = True Then 
        Cursor = Cursors.Default 
        Try 
          My.Computer.FileSystem.WriteAllText(pFilenameOut, pIncomingObjectToTranslates.ToCSV, False) 
        Catch ex As Exception 
    ...
    pFault = pIncomingObjectToTranslates.UpdateFromCollection(_Requester) 
    ...
    pErrorFound = False 
    For Each p In pIncomingObjectToTranslates 
      If p.Tag <> "OK" Then 
        pErrorFound = True 
      End If 
    Next 
    If pErrorFound = True Then 
      ...
      Exit Sub 
    Else 
      _ObjectToTranslateCol = pIncomingObjectToTranslates 
      LoadGrid() 
  ...
  Private Sub DoEdit() 
    ...
    If dgvObjectToTranslate.Focused = True AndAlso dgvObjectToTranslate.SelectedRows.Count > 0 Then 
      pCellRow = dgvObjectToTranslate.CurrentCell.RowIndex 
      pCellCol = dgvObjectToTranslate.CurrentCell.ColumnIndex 
    End If 
 
    Try 'in case it's empty 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(0).Cells(0) 
      dgvObjectToTranslate.CurrentCell.Selected = True 
    Catch ex As Exception 
    End Try 
 
 
    'remove summary row 
    If _LoadParameters.SummarizeGrid = True AndAlso _ObjectToTranslateCol.Count > 0 AndAlso _ObjectToTranslateCol(_ObjectToTranslateCol.Count - 1).ID = 0 Then 
      _ObjectToTranslateCol.RemoveAt(_ObjectToTranslateCol.Count - 1) 
      bsCtlObjectToTranslate.DataSource = Nothing 
      bsCtlObjectToTranslate.DataSource = _ObjectToTranslateCol 
      _Summarized = False 
    End If 
    ...
    If pCellRow >= 0 AndAlso pCellCol >= 0 Then 
      dgvObjectToTranslate.Focus() 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(pCellRow).Cells(pCellCol) 
      dgvObjectToTranslate.CurrentCell.Selected = True 
    ElseIf _ObjectToTranslateCol.Count = 0 Then 
    Else 
  ...
  Private Sub DoAdd() 
    ...
    bsCtlObjectToTranslate.AddNew() 
 
    'Now choose any needed fields 
    Dim pEntity As csObjectToTranslate 
    pEntity = CType(bsCtlObjectToTranslate.Current, csObjectToTranslate) 
  ...
  Private Function DoDelete() As clsFault 
    ...
    If dgvObjectToTranslate.CurrentCell Is Nothing Then Return pFault 
    
    If dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
      Dim pObjectToTranslate As csObjectToTranslate 
      pObjectToTranslate = CType(bsCtlObjectToTranslate.Current, csObjectToTranslate) 
      If pObjectToTranslate Is Nothing Then 
        pFault.LogFreeTextFault("There is no ObjectToTranslate to delete", "", "TRGT-110303-165408", _Requester) 
        Return pFault 
      End If 
      Dim pOriginalCol As Integer = dgvObjectToTranslate.CurrentCell.ColumnIndex 
      Dim pOriginalRow As Integer = dgvObjectToTranslate.CurrentCell.RowIndex 
      'show row as selected  
      dgvObjectToTranslate.SelectionMode = DataGridViewSelectionMode.FullRowSelect 
      dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditProgrammatically 
      dgvObjectToTranslate.CurrentRow.Selected = True 
      If pObjectToTranslate.ID > 0 Then 
        Dim pRequest As String = "Are you sure you want to delete '" & pObjectToTranslate.ObjectType.FastToString() & ": " & pObjectToTranslate.Object & ": " & pObjectToTranslate.Item & "'?" 
        Dim pCancel As Nullable(Of Boolean) = Nothing 
        RaiseEvent evtBeforeDelete(pObjectToTranslate, pCancel) 
        ...
        ElseIf pCancel Is Nothing Then 
          ...
          If pResponse = frmMessageOrInputBox.enmButtonReturned.No Then 
            dgvObjectToTranslate.SelectionMode = DataGridViewSelectionMode.CellSelect 
            dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 
            dgvObjectToTranslate.Rows(pOriginalRow).Cells(pOriginalCol).Selected = True 
            Return pFault 
          End If 
        End If 
        pFault = pObjectToTranslate.Delete(_Requester) : If pFault.isOK = False Then Return pFault 
      End If 
      bsCtlObjectToTranslate.Remove(bsCtlObjectToTranslate.Current) 
      LoadGrid() 
    End If 
    Return pFault 
  End Function 
  Private Sub DoCeaseEdit() 
    ...
    If _DVGDirty = True Then 
      ...
      Exit Sub 
    End If 
    Dim pObjectToTranslate As csObjectToTranslate = CType(bsCtlObjectToTranslate.Current, csObjectToTranslate) 
    If pObjectToTranslate IsNot Nothing Then 
      If pObjectToTranslate.ID = 0 Then 
    ...
    End If 
    SetUpBNButtons(False) 
    If _ObjectToTranslateCol.Count > 0 AndAlso dgvObjectToTranslate.CurrentCell IsNot Nothing Then 
      For i As Integer = 0 To dgvObjectToTranslate.Columns.Count - 1 
        If dgvObjectToTranslate.Columns(i).Visible Then 
          dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(dgvObjectToTranslate.CurrentCell.RowIndex).Cells(i) 
          Exit For 
        End If 
      Next 
      dgvObjectToTranslate.Refresh() 
      dgvObjectToTranslate.Rows(dgvObjectToTranslate.CurrentCell.RowIndex).Selected = True 
    Else 
      dgvObjectToTranslate.Refresh() 
    End If 
  End Sub 
  'Grid RowValidating 
  Private Sub dgvObjectToTranslate_RowValidating(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellCancelEventArgs) Handles dgvObjectToTranslate.RowValidating 
    If _Loading = True OrElse dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditProgrammatically Then Exit Sub 
    Dim pCancel As Boolean 
    pCancel = UpdateRow() 
    If pCancel = True Then 
      e.Cancel = True 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(e.RowIndex).Cells(e.ColumnIndex) 
    End If 
  End Sub 
  'CellFormatting  
  Private Sub dgvObjectToTranslate_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dgvObjectToTranslate.CellFormatting 
    '_Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
 
    If dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2 Then 
      If dgvObjectToTranslate.Columns(e.ColumnIndex).ReadOnly = False Then 
        Exit Sub 
      End If 
    End If 
    ...
    'If dgvObjectToTranslate.Columns(e.ColumnIndex).Name = colRecommendedQuantityToOrder.Name Then 
    '  If pObjectToTranslate Is Nothing Then pObjectToTranslate = CType(dgvObjectToTranslate.Rows(e.RowIndex).DataBoundItem, csObjectToTranslate) ' Only assign it if needed 
    '  If pObjectToTranslate.CustomerOrders > 10 Then 
    '    e.CellStyle.ForeColor = Color.Red 
    '    If pObjectToTranslate.CustomerOrders > 100 Then 
    '      e.CellStyle.BackColor = Color.LightYellow 
    '    End If 
    '  End If 
    'End If 
    'If dgvObjectToTranslate.Columns(e.ColumnIndex).Name = colRAV.Name Then 
    '  If pObjectToTranslate Is Nothing Then pObjectToTranslate = CType(dgvObjectToTranslate.Rows(e.RowIndex).DataBoundItem, csObjectToTranslate) ' Only assign it if needed
    '  If pObjectToTranslate.RAV > 10 Then 
    '    e.CellStyle.ForeColor = Color.Red 
    '    If pObjectToTranslate.RAV - pObjectToTranslate.MaximumStock > 100 Then 
    '      e.CellStyle.BackColor = Color.LightYellow 
    '    End If 
    '  End If 
    'End If 
 
    'Debug.Print("loc x,y:" & e.RowIndex & ", " & e.ColumnIndex & ": GetType" & dgvObjectToTranslate.Columns(e.ColumnIndex).GetType.ToString & ": zValue" & e.Value.ToString) 
    If dgvObjectToTranslate.Columns(e.ColumnIndex).GetType.ToString = "System.Windows.Forms.DataGridViewComboBoxColumn" Then 
      Dim pCol As System.Windows.Forms.DataGridViewComboBoxColumn = CType(dgvObjectToTranslate.Columns(e.ColumnIndex), System.Windows.Forms.DataGridViewComboBoxColumn) 
      Dim pTag As String = "" 
      ...
      If pTag <> "" Then 
        If e.Value Is Nothing Then 
          'e.Value = "## INVALID ##" 
          e.Value = "* BadCode '" & dgvObjectToTranslate.Rows(e.RowIndex).Cells(e.ColumnIndex).Value.ToString() & "' *" 
    ...
    If dgvObjectToTranslate.Columns(e.ColumnIndex).GetType.Name.Equals("DataGridViewImageColumn", StringComparison.OrdinalIgnoreCase) Then 
      If e.Value Is Nothing Then 
    ...
    If _Summarized = True Then 
      If e.RowIndex = dgvObjectToTranslate.Rows.Count - 1 Then 
        If e.Value IsNot Nothing Then 
          ...
          ElseIf e.Value.ToString = "0" Then 
            e.Value = "" 
          Else 
            If _SummaryOverFlow.IndexOf(dgvObjectToTranslate.Columns(e.ColumnIndex).Name.Substring(3)) >= 0 Then 
              e.Value = "* OVERFLOW *" 
            End If 
          End If 
        Else 
    ...
    End If 
  End Sub 
  Private Sub dgvObjectToTranslate_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles dgvObjectToTranslate.CellValueChanged 
    If e.RowIndex < 0 Then Exit Sub 
 
  End Sub 
 
  'Grid Sort
  Private Sub dgvObjectToTranslate_ColumnHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvObjectToTranslate.ColumnHeaderMouseClick
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    Dim pNewColumn As DataGridViewColumn = dgvObjectToTranslate.Columns(e.ColumnIndex)
    If bsCtlObjectToTranslate.Current Is Nothing Then Exit Sub
    ...
    Cursor = Cursors.WaitCursor
    dgvObjectToTranslate.SuspendLayout()

    Dim pObjectToTranslate As csObjectToTranslate
    Dim pID As Long = 0 
    If dgvObjectToTranslate.SelectedRows.Count > 0 Then 
    pObjectToTranslate = CType(bsCtlObjectToTranslate.Current, csObjectToTranslate)
      pID = pObjectToTranslate.ID 
    End If 
    ...
    Dim pObjectToTranslateCol As csObjectToTranslateCol
    pObjectToTranslateCol = CType(bsCtlObjectToTranslate.DataSource, csObjectToTranslateCol)

    Dim pSummaryRow As csObjectToTranslate = Nothing 
    If _Summarized = True Then 
      pSummaryRow = pObjectToTranslateCol(pObjectToTranslateCol.Count - 1) 
      pObjectToTranslateCol.RemoveAt(pObjectToTranslateCol.Count - 1) 
    End If 
    ...
    If pNewSortOrder = SortOrder.Ascending Then
      If _PrevSortColumn IsNot Nothing AndAlso _PrevSortColumn IsNot pNewColumn Then 
        ...
        For iCntr As Integer = 0 To pObjectToTranslateCol.Count - 1 
          pObjectToTranslateCol(iCntr).Tag = iCntr.ToString("0000000000") 
        Next 
      End If 
      If pNewColumn Is colID Then
        pObjectToTranslateCol.SortByID()
      ElseIf pNewColumn Is colObjectType Then
        pObjectToTranslateCol.SortByObjectType()
      ElseIf pNewColumn Is colObject Then
        pObjectToTranslateCol.SortByObject()
      ElseIf pNewColumn Is colItem Then
        pObjectToTranslateCol.SortByItem()
      End If
      If _PrevSortColumn IsNot Nothing AndAlso _PrevSortColumn IsNot pNewColumn Then 
      Dim iCntr As Integer = 0 
        If pNewColumn Is colID Then
          Dim pTest As Long = 0 
          For Each p As csObjectToTranslate In pObjectToTranslateCol 
            If p.ID <> pTest Then iCntr += 1 : pTest = p.ID 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colObjectType Then
          Dim pTest As clsEnums.enmObjectType = clsEnums.enmObjectType.UD 
          For Each p As csObjectToTranslate In pObjectToTranslateCol 
            If p.ObjectType <> pTest Then iCntr += 1 : pTest = p.ObjectType 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colObject Then
          Dim pTest As String = "" 
          For Each p As csObjectToTranslate In pObjectToTranslateCol 
            If p.Object <> pTest Then iCntr += 1 : pTest = p.Object 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        ElseIf pNewColumn Is colItem Then
          Dim pTest As String = "" 
          For Each p As csObjectToTranslate In pObjectToTranslateCol 
            If p.Item <> pTest Then iCntr += 1 : pTest = p.Item 
            p.Tag = iCntr.ToString("0000000000") & p.Tag 
          Next 
        End If 
        pObjectToTranslateCol.SortByTag() 
      End If 
      pNewColumn.HeaderCell.SortGlyphDirection = SortOrder.Ascending
      _PrevSortColumn = pNewColumn
      pPrevSortOrder = SortOrder.Ascending
    Else
      pObjectToTranslateCol.Reverse()
      pNewColumn.HeaderCell.SortGlyphDirection = SortOrder.Descending
      pPrevSortOrder = SortOrder.Descending
    End If

    If _Summarized = True Then 
      pObjectToTranslateCol.Add(pSummaryRow) 
    End If 
 
    If pID > 0 Then
      bsCtlObjectToTranslate.Position = bsCtlObjectToTranslate.IndexOf(pObjectToTranslateCol.FindByID(pID))
    End If

    'dgvObjectToTranslate.AutoResizeRows(DataGridViewAutoSizeRowsMode.AllCells) 
    dgvObjectToTranslate.ResumeLayout()
  ...
  Public Sub SelectRowByObjectID(ByVal pID As Long) 
    If pID > 0 Then 
      Dim pObjectToTranslateCol As csObjectToTranslateCol 
      pObjectToTranslateCol = CType(bsCtlObjectToTranslate.DataSource, csObjectToTranslateCol) 
      Dim pObjectToTranslate As csObjectToTranslate = pObjectToTranslateCol.FindByID(pID) 
      If Not pObjectToTranslate.IsEmpty Then 
        bsCtlObjectToTranslate.Position = bsCtlObjectToTranslate.IndexOf(pObjectToTranslateCol.FindByID(pID)) 
        dgvObjectToTranslate.Rows(bsCtlObjectToTranslate.Position).Selected = True 
      Else 
        dgvObjectToTranslate.ClearSelection() 
      End If 
    ElseIf pID = 0 Then 
  ...
  'Grid Resize
  Private Sub dgvObjectToTranslate_ColumnHeaderMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgvObjectToTranslate.ColumnHeaderMouseDoubleClick
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    Cursor = Cursors.WaitCursor
    dgvObjectToTranslate.AutoResizeColumn(e.ColumnIndex)
    Cursor = Cursors.Default
  End Sub
  'Other Grid Events
  Private Sub dgvObjectToTranslate_CurrentCellDirtyStateChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvObjectToTranslate.CurrentCellDirtyStateChanged
   _DVGDirty = True 
  End Sub
  Private Sub dgvObjectToTranslate_Scroll(sender As Object, e As ScrollEventArgs) Handles dgvObjectToTranslate.Scroll
    dgvObjectToTranslate.Invalidate() 
  End Sub
 
  Private Sub dgvObjectToTranslate_DataFault(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewDataErrorEventArgs) Handles dgvObjectToTranslate.DataError
    'Dim pFault As New clsFault
    '
    'If e.RowIndex = dgvObjectToTranslate.Rows.Count - 1 Then Exit Sub
 
    'If dgvObjectToTranslate.Columns(e.ColumnIndex).Name.StartsWith("colIDin", StringComparison.OrdinalIgnoreCase) Then Exit Sub 
    ...
    'Try 
    '  Try 
    '    pSubStrg.AppendLine("In table 'ObjectToTranslate', the row with an ID of " & dgvObjectToTranslate.Rows(e.RowIndex).Cells(0).Value.ToString)
    '  Catch ex As Exception 
    '    pSubStrg.AppendLine("In grid 'ObjectToTranslate', row index " & e.RowIndex) 
    '  End Try 
    '  Try 
    '    pSubStrg.AppendLine(" has an invalid value of " & dgvObjectToTranslate.Rows(e.RowIndex).Cells(e.ColumnIndex).Value.ToString)
    '  Catch ex As Exception 
    '    pSubStrg.AppendLine(" has an invalid value of Nothing.") 
    '  End Try 
    '  pSubStrg.AppendLine(" in column " & dgvObjectToTranslate.Columns(e.ColumnIndex).DataPropertyName) 
    'Catch ex As Exception 
    '  pSubStrg.AppendLine("; Failed trying to fill DataFault as well!") 
    'End Try 
    'pFault.LogException(209, e.Exception, pSubStrg.ToString, "TRGT-ObjectToTranslate-100409-2248", _Requester) 
    'If pShown = False Then 
    '  Dim pCell As DataGridViewCell 
    '  Try 
    '    pCell = dgvObjectToTranslate(e.ColumnIndex, e.RowIndex)
    '  Catch ex As Exception 
    '    pCell = dgvObjectToTranslate(0, 0)
    '  End Try 
    '  ShowFault(pFault, _Requester) 
    '  pShown = True 
    'End If 
  End Sub
  Private Sub dgvObjectToTranslate_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvObjectToTranslate.KeyDown 
    If e.KeyCode = Keys.Escape Then 
      ...
      End If 
      SetUpBNButtons(False) 
      'dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.Rows(dgvObjectToTranslate.CurrentCell.RowIndex).Cells(0) 
      dgvObjectToTranslate.Refresh() 
    End If 
  End Sub 
  Private Sub dgvObjectToTranslate_ColumnWidthChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles dgvObjectToTranslate.ColumnWidthChanged
    If Me.DesignMode = True Then Exit Sub 
    If _Loading = False Then SaveSizes()
  End Sub
  Private Sub dgvObjectToTranslate_ColumnDisplayIndexChanged(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewColumnEventArgs) Handles dgvObjectToTranslate.ColumnDisplayIndexChanged
    Cursor = Cursors.WaitCursor
    If _Loading = False Then SaveSizes()
    Cursor = Cursors.Default
  End Sub
  Private Sub dgvObjectToTranslate_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvObjectToTranslate.CellDoubleClick 
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    If e.RowIndex < 0 Then Exit Sub 
    If _Summarized = True AndAlso e.RowIndex = dgvObjectToTranslate.Rows.Count - 1 Then Exit Sub 
    Cursor = Cursors.WaitCursor 
    Dim pCell As DataGridViewCell = dgvObjectToTranslate(e.ColumnIndex, e.RowIndex) 
 
    Dim pHandled As Boolean = False 
    Dim pObjectToTranslate As csObjectToTranslate = _ObjectToTranslateCol(e.RowIndex)
    RaiseEvent evtRowDoubleClicked(pObjectToTranslate, pHandled) 
    Cursor = Cursors.Default 
 
    If pHandled = False Then 
      If Me.ParentForm.Name.Equals("frmPopup", StringComparison.OrdinalIgnoreCase) Then Return 
      frmPopup.Text = "ObjectToTranslate Detail" 
      Dim pFault As clsFault = frmPopup.LoadControl("ctlc_ObjectToTranslate", pObjectToTranslate, _Requester) 
      If Not pFault.isOK Then ShowFault(pFault, _Requester) : Exit Sub 
      frmPopup.ShowDialog() 
    End If 
 
  End Sub 
  Private Sub dgvObjectToTranslate_SelectionChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvObjectToTranslate.SelectionChanged 
    If btnCeaseEdit.Visible = True Then Exit Sub 
    _Requester.CallingFunctionWithinApplication = System.Reflection.MethodInfo.GetCurrentMethod().DeclaringType.Name & ":" & System.Reflection.MethodInfo.GetCurrentMethod().Name 
    ...
    If _Summarized = True AndAlso RowIndex = dgvObjectToTranslate.Rows.Count - 1 Then dgvObjectToTranslate.ClearSelection() : RaiseEvent evtUnChosen() : Exit Sub 
    Dim pObjectToTranslate As csObjectToTranslate = _ObjectToTranslateCol(RowIndex)
    _ProcessingSelection = True
    Try
      RaiseEvent evtRowClicked(pObjectToTranslate) 
    Finally
      _IgnoreSelectionUntil = DateTime.Now.AddMilliseconds(500)
      _ProcessingSelection = False
    End Try
  End Sub 
  Private Sub dgvObjectToTranslate_RowLeave(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvObjectToTranslate.RowLeave 
    colID.ReadOnly = True 
  End Sub 
  ...
  Private Function UpdateRow() As Boolean 
    ...
    If pOriginalCol > 0 Then 
      ...
      Do Until dgvObjectToTranslate.Columns(pNewCol).Visible = True OrElse pNewCol = 0 
        pNewCol = pNewCol - 1 
      Loop 
    Else 
      pNewCol = 1 
    End If 
    If dgvObjectToTranslate.Columns(pNewCol).Visible = False Then 
      dgvObjectToTranslate.Columns(pNewCol).Visible = True 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.CurrentRow.Cells(pNewCol) 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.CurrentRow.Cells(pOriginalCol) 
      dgvObjectToTranslate.Columns(pNewCol).Visible = False 
    Else 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.CurrentRow.Cells(pNewCol) 
      dgvObjectToTranslate.CurrentCell = dgvObjectToTranslate.CurrentRow.Cells(pOriginalCol) 
    End If 
    ...
    RaiseEvent evtBeforeUpdate(CType(pObjectToTranslate, csObjectToTranslate), pCancel) 
    If pCancel = True Then 
      _DVGDirty = False 
      RaiseEvent evtTimerTripped() 
      Return True 
    End If 
    pFault = pObjectToTranslate.Update(_Requester) 
    ...
    Else 
      If pFault.isOK = False Then 'AndAlso pFault.Severity = clsEnums.enmFaultSeverity.LogOnly  
        ShowFault(pFault, _Requester) 
      End If 
      dgvObjectToTranslate.EndEdit() 
      _DVGDirty = False 
      'Reset the ObjectToTranslate collection 
      MyCache.ClearComboList(clsEnums.enmComboListType.c_ObjectToTranslateDefaultByID) 
      RaiseEvent evtUpdated(pObjectToTranslate) 
      Return False 
    End If 
  End Function 
  Private Sub SaveSizes() 
    ...
    For Each pCol As DataGridViewColumn In dgvObjectToTranslate.Columns 
  ...
  Private Sub Summarize() 
    If _ObjectToTranslateCol.Count <= 1 Then 
      _Summarized = False 
      Exit Sub 
    End If 
 
    For Each pExistingRow As csObjectToTranslate In _ObjectToTranslateCol 
    Next 
    _Summarized = False 
  End Sub 
  ...
  Friend Function CreateSpreadSheet() As clsFault  
    ...
    Dim pFileNameAllFields As String = $"{pRoot}\ObjectToTranslateCol_{pDateToShow}AllFields.csv" 
    Dim pFileNameFieldsOnGrid As String = $"{pRoot}\ObjectToTranslateCol_{pDateToShow}FieldsOnGrid.csv" 
    Dim pFileNameAllFieldsWithIDs As String = $"{pRoot}\ObjectToTranslateCol_{pDateToShow}AllFieldsWithIDs.csv" 
    Dim pFileNameAllFieldsXML As String = $"{pRoot}\ObjectToTranslateCol_{pDateToShow}AllFields.xml" 
    Dim pFileNameAllFieldsJson As String = $"{pRoot}\ObjectToTranslateCol_{pDateToShow}AllFields.json" 
    ...
    For Each Row As DataGridViewRow In dgvObjectToTranslate.Rows 
      i += 1 
      If _LoadParameters.SummarizeGrid = True Then 
        If Row.Index = dgvObjectToTranslate.Rows.Count - 1 Then Exit For 
      End If 
      If i Mod 500 = 0 Then 
    ...
    Try  
      If pShowAllFields = True Then  
        Dim pStrg As String = "" 
        'xml 
        pFault = _ObjectToTranslateColFullLength.CreateXML(pStrg, _Requester) : If pFault.isOK = False Then Return pFault 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsXML, pStrg, False) 
        'json 
        pFault = _ObjectToTranslateColFullLength.CreateJSON(pStrg, _Requester) : If pFault.isOK = False Then Return pFault 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsJson, pStrg, False) 
        'default  
        My.Computer.FileSystem.WriteAllText(pFileNameAllFields, _ObjectToTranslateColFullLength.ToCSV, False)  
        'WithIDs  
        'pFault = _ObjectToTranslateColFullLength.LoadLookupAndEnumText(_Requester) : If pFault.isOK = False Then Return pFault (already done) 
        My.Computer.FileSystem.WriteAllText(pFileNameAllFieldsWithIDs, _ObjectToTranslateColFullLength.ToCSV(True), False) 
      End If  
      'default  
      My.Computer.FileSystem.WriteAllText(pFileNameFieldsOnGrid, pCSV.ToString, False)  
      pFault.SetOK()  
    Catch ex As Exception  
      pFault.LogException(ex, "", "TRGT-ObjectToTranslate-090210-1618", _Requester)  
    End Try  
    If pFault.isOK = False Then Return pFault  
  ...
  Private Sub ReportDesign() 
    ...
    Try 
      ...
      With _Report 
        ...
        .SubTitleLeft = "ObjectToTranslates" 
        .SubTitleRight = "Rows: " & _ObjectToTranslateCol.Count.ToString 
        ...
        End If 
        .DataSource = _ObjectToTranslateCol 
        .HasSummaryLine = _Summarized 
      End With 
    Catch ex As Exception 
      Dim pFault As New clsFault 
      pFault.LogException(ex, "", "TRGT-ObjectToTranslate-090210-2119", _Requester) : ShowFault(pFault, _Requester) : Exit Sub 
    End Try 
  End Sub 
  Friend Function CreateReport() As clsFault 
    ...
    Catch ex As Exception 
      pFault = New clsFault 
      pFault.LogException(ex, "", "TRGT-ObjectToTranslate-090211-0746", _Requester) 
    End Try 
    Return pFault 
  End Function 
  ...
  Private Sub txtSearch_TextChanged(sender As Object, e As EventArgs) Handles txtSearch.TextChanged 
    ...
    If String.IsNullOrEmpty(pSearchText) Then 
      For Each pRow As DataGridViewRow In dgvObjectToTranslate.Rows 
    ...
    For Each row As DataGridViewRow In dgvObjectToTranslate.Rows 
      ...
      Next 
      Try 
        Dim pBS As CurrencyManager = CType(Me.BindingContext(bsCtlObjectToTranslate), CurrencyManager) 
    ...
    lblStatus.Text = pVisibleCount & " of " & dgvObjectToTranslate.RowCount & " rows" 
  End Sub 
  ...
  Private Function GetOrInitializeGridSettings() As clsFault 
    ...
    Catch ex As Exception 
      pFault.LogException(ex, "GetOrInitializeGridSettings", "TRGT-ObjectToTranslate-120225-1310", _Requester) 
    End Try 
    If pFault.isOK = False Then Return pFault 
    ...
    Else 
      ...
      For Each pCol As DataGridViewColumn In dgvObjectToTranslate.Columns 
        ...
        If pG.ColumnName = "" Then 
          pG.ColumnDisplayIndex = pCol.DisplayIndex 
          pG.ColumnWidth = ccHelper.ToInteger((dgvObjectToTranslate.Width - 30) / dgvObjectToTranslate.Columns.Count) 
  ...
  Private Sub LoadColumns() 
    ...
    'Set Wrap 
    'colItem.DefaultCellStyle.WrapMode = DataGridViewTriState.True 
    ...
    Try 
      For Each lGridSetting In _GridSettings 
        Try 
          ...
          With dgvObjectToTranslate.Columns(lGridSetting.ColumnName) 
    ...
    Catch ex As Exception 'Fault in getting GridSettings  
      pFault.LogException(204, ex, "", "TRGT-ObjectToTranslate-090120-1502", _Requester) : ShowFault(pFault, _Requester) : Exit Sub 
    End Try 
  End Sub 
  ...
  Private Sub LoadLocalizedText() 
    ...
    If pStrg <> "" Then colObjectType.HeaderText = pStrg : mnuColVisibleObjectType.Text = pStrg
 
    pStrg = ccHelper.GetLocalizedFieldName("c_ObjectToTranslate", "Object", _Requester) 
    If pStrg <> "" Then colObject.HeaderText = pStrg : mnuColVisibleObject.Text = pStrg
 
    pStrg = ccHelper.GetLocalizedFieldName("c_ObjectToTranslate", "Item", _Requester) 
    If pStrg <> "" Then colItem.HeaderText = pStrg : mnuColVisibleItem.Text = pStrg
  ...
  Private Sub mnuColVisible_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColVisibleID.Click, mnuColVisibleObjectType.Click, mnuColVisibleObject.Click, mnuColVisibleItem.Click
    Cursor = Cursors.WaitCursor 
    Dim pToolStripItem As System.Windows.Forms.ToolStripMenuItem = CType(sender, System.Windows.Forms.ToolStripMenuItem) 
    dgvObjectToTranslate.Columns("col" & pToolStripItem.Name.Substring(13)).Visible = pToolStripItem.Checked 
    If _Loading = False Then SaveSizes() 
    Cursor = Cursors.Default 
  End Sub 
  Private Sub mnuColsReset_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColsReset.Click 
    ...
    pNewWidth = ccHelper.ToInteger((dgvObjectToTranslate.Width - 30) / pVisibleColumns) 
  ...
  Private Sub mnuColsHideMost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuColsHideMost.Click 
    ...
    If mnuColVisibleObjectType.Checked = True Then mnuColVisibleObjectType.PerformClick() 
    If mnuColVisibleObject.Checked = True Then mnuColVisibleObject.PerformClick() 
    If mnuColVisibleItem.Checked = True Then mnuColVisibleItem.PerformClick() 
    'Show Defaults 
    If mnuColVisibleObjectType.Checked = False Then mnuColVisibleObjectType.PerformClick() 
    If mnuColVisibleObject.Checked = False Then mnuColVisibleObject.PerformClick() 
    If mnuColVisibleItem.Checked = False Then mnuColVisibleItem.PerformClick() 
    
    _Loading = False 
    'dgvObjectToTranslate.AutoResizeRows(DataGridViewAutoSizeRowsMode.AllCells) 
  End Sub 
  
  Private Sub dgvObjectToTranslate_CellMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvObjectToTranslate.CellMouseClick 
    If e.Button = MouseButtons.Right Then 
      Dim pMessageBox As frmMessageOrInputBox.enmButtonReturned = frmMessageOrInputBox.ShowMsg("How do you want to copy the ObjectToTranslate to the clipboard?", frmMessageOrInputBox.enmIconType.QuestionMark, frmMessageOrInputBox.enmButtons.YesNoCancel, vYesText:="Text", vNoText:="CSV") 
  ...
  Private Sub dgvObjectToTranslate_MouseDown(sender As Object, e As MouseEventArgs) Handles dgvObjectToTranslate.MouseDown 
    '--- Save anchor on normal click (no modifiers) ---
    Dim pModifiers = Control.ModifierKeys 
    If (pModifiers And (Keys.Shift Or Keys.Control)) = 0 AndAlso dgvObjectToTranslate.CurrentRow IsNot Nothing Then 
      _SelectionAnchor = dgvObjectToTranslate.CurrentRow.Index 
    End If 
    'This removes on click from the update 
    If dgvObjectToTranslate.EditMode = DataGridViewEditMode.EditProgrammatically Then Exit Sub 
 
    Dim pCell As DataGridView.HitTestInfo = dgvObjectToTranslate.HitTest(e.X, e.Y) 
    ...
    If pCell.Type = DataGridViewHitTestType.Cell Then 
      ...
      Try 
        pCurrentCell = dgvObjectToTranslate(pCell.ColumnIndex, pCell.RowIndex) 
        If pCurrentCell.ReadOnly Then Exit Sub 
        dgvObjectToTranslate.CurrentCell = pCurrentCell 
      Catch ex As Exception 
        Exit Sub  
      End Try 
      ...
      If pCurrentCell.GetType().Name.Equals("DataGridViewComboBoxCell", StringComparison.OrdinalIgnoreCase) Then 
        dgvObjectToTranslate.BeginEdit(True) 
        DirectCast(dgvObjectToTranslate.EditingControl, DataGridViewComboBoxEditingControl).DroppedDown = True 
      End If 
    End If 
  End Sub 
 
  Private Sub dgvObjectToTranslate_MouseUp(sender As Object, e As MouseEventArgs) Handles dgvObjectToTranslate.MouseUp 
    Dim pModifiers = Control.ModifierKeys 
    If (pModifiers And Keys.Shift) = Keys.Shift AndAlso _SelectionAnchor >= 0 Then 
      Dim hit = dgvObjectToTranslate.HitTest(e.X, e.Y) 
      If hit.RowIndex >= 0 Then 
        dgvObjectToTranslate.MultiSelect = True 
        dgvObjectToTranslate.ClearSelection() 
        ...
        For i As Integer = pFrom To pTo 
          dgvObjectToTranslate.Rows(i).Selected = True 
        Next 
      End If 
    ElseIf (pModifiers And Keys.Control) = Keys.Control Then 
      dgvObjectToTranslate.MultiSelect = True 
    Else 
      dgvObjectToTranslate.MultiSelect = False 
    End If 
  End Sub 
  ...
  Private Sub ctlc_ObjectToTranslateCol_FontChanged(sender As Object, e As EventArgs) Handles Me.FontChanged 
    'Set the font for the BN 
        If MyFont Is Nothing Then Return 
    BN.Font = New Font(MyFont.Name, MyFont.Size) 
    dgvObjectToTranslate.RowTemplate.Height = ccHelper.ToInteger(23 * MyFont.Size / 9) 
  End Sub 
 
  Private Sub ctlc_ObjectToTranslateCol_SizeChanged(sender As Object, e As EventArgs) Handles Me.SizeChanged 
    If Me.ParentForm Is Nothing Then Exit Sub 
    Dim pParent As String = Me.ParentForm.Name 
    Dim pResponse As Boolean = Me.Visible 
    Dim pSize As Integer = dgvObjectToTranslate.Width 
  ...
  Private Sub ctlc_ObjectToTranslateCol_VisibleChanged(sender As Object, e As EventArgs) Handles Me.VisibleChanged 
  ...
  Private Sub ctlc_ObjectToTranslateCol_Leave(sender As Object, e As EventArgs) Handles Me.Leave 
  ...
  Private Sub dgvObjectToTranslate_CellMouseDown(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgvObjectToTranslate.CellMouseDown 
    ReleaseStuckModifierKeys() 'Fix sticky SHIFT/CTRL before selection changes 
    If e.Button = MouseButtons.Right AndAlso e.RowIndex >= 0 Then 
      If Not dgvObjectToTranslate.Rows(e.RowIndex).Selected Then 
        dgvObjectToTranslate.ClearSelection() 
        dgvObjectToTranslate.Rows(e.RowIndex).Selected = True 
      End If 
    End If 
  End Sub 
  ...
  Private Sub cmsGrid_Opening(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles cmsGrid.Opening 
    Dim pCount As Integer = dgvObjectToTranslate.SelectedRows.Count 
  ...
  Private Sub tsmiOpenDetail_Click(sender As Object, e As EventArgs) Handles tsmiOpenDetail.Click 
    If dgvObjectToTranslate.SelectedRows.Count <> 1 Then Exit Sub 
    Dim pRowIndex As Integer = dgvObjectToTranslate.SelectedRows(0).Index 
    If pRowIndex < 0 OrElse pRowIndex >= _ObjectToTranslateCol.Count Then Exit Sub 
    Dim pObjectToTranslate As csObjectToTranslate = _ObjectToTranslateCol(pRowIndex) 
    Dim pTitle As String = "ObjectToTranslate #" & pObjectToTranslate.ID.ToString() 
    Dim pKey As String = "ObjectToTranslate_" & pObjectToTranslate.ID.ToString() 
    ...
    Dim pCtlName As String = "ctlc_ObjectToTranslate" 
    ...
    Dim pFault As clsFault = CType(pLoad.Invoke(pControl, New Object() {pObjectToTranslate, _Requester}), clsFault) 
    If Not pFault.isOK Then ShowFault(pFault, _Requester) : Exit Sub 
    'Return to Tab click handler - sends entity to a new tab in frmMain 
    Dim pEntityRef As Object = pObjectToTranslate 
  ...
  Private Sub tsmiOpenInTab_Click(sender As Object, e As EventArgs) Handles tsmiOpenInTab.Click 
    ...
    Dim pWinKey As String = "ObjectToTranslate_" & pObjectToTranslate.ID.ToString() 
    If _openDetailWindows.ContainsKey(pWinKey) Then 
      ...
      End If 
    End If 
    Dim pTabTitle As String = "ObjectToTranslate #" & pObjectToTranslate.ID.ToString() 
    Dim pFault As clsFault = pFrmMain.OpenEntityInNewTab("ctlc_ObjectToTranslate", pObjectToTranslate, _Requester, pTabTitle) 
  ...
  Private Sub tsmiCopyID_Click(sender As Object, e As EventArgs) Handles tsmiCopyID.Click 
    If dgvObjectToTranslate.SelectedRows.Count = 0 Then Exit Sub 
    Dim pIDs As New System.Text.StringBuilder() 
    For Each pSelectedRow As DataGridViewRow In dgvObjectToTranslate.SelectedRows 
      If pSelectedRow.Index >= 0 AndAlso pSelectedRow.Index < _ObjectToTranslateCol.Count Then 
        Dim pObjectToTranslate As csObjectToTranslate = _ObjectToTranslateCol(pSelectedRow.Index) 
        If pIDs.Length > 0 Then pIDs.Append(", ") 
        pIDs.Append(pObjectToTranslate.ID.ToString()) 
      End If 
    Next 
  ...
  Private Sub tsmiCopyRowHeaders_Click(sender As Object, e As EventArgs) Handles tsmiCopyRowHeaders.Click 
    ...
    Dim pFirstRow As DataGridViewRow = dgvObjectToTranslate.SelectedRows(0) 
