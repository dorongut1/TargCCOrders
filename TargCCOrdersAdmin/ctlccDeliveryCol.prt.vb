Partial Public Class ctlccDeliveryCol
  ...
  Private Sub ctlccDeliveryCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsDelivery.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsDelivery.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccDeliveryCol_evtLoaded() Handles Me.evtLoaded 
