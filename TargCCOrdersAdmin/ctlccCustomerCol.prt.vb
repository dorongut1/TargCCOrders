Partial Public Class ctlccCustomerCol
  ...
  Private Sub ctlccCustomerCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsCustomer.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsCustomer.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccCustomerCol_evtLoaded() Handles Me.evtLoaded 
