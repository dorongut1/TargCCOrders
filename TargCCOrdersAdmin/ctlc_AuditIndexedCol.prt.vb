Partial Public Class ctlc_AuditIndexedCol
  ...
  Private Sub ctlc_AuditIndexedCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csAuditIndexed.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csAuditIndexed.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_AuditIndexedCol_evtLoaded() Handles Me.evtLoaded 
