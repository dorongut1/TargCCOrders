Partial Public Class ctlc_UserStatusCol
  ...
  Private Sub ctlc_UserStatusCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csUserStatus.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csUserStatus.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_UserStatusCol_evtLoaded() Handles Me.evtLoaded 
