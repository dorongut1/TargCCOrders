Partial Public Class ctlccCustomerDebtCol
  ...
  Private Sub ctlccCustomerDebtCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsCustomerDebt.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsCustomerDebt.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccCustomerDebtCol_evtLoaded() Handles Me.evtLoaded 
