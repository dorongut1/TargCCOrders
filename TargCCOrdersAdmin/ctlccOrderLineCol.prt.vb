Partial Public Class ctlccOrderLineCol
  ...
  Private Sub ctlccOrderLineCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsOrderLine.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsOrderLine.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccOrderLineCol_evtLoaded() Handles Me.evtLoaded 
