Partial Public Class ctlc_LoggedJobCol
  ...
  Private Sub ctlc_LoggedJobCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLoggedJob.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLoggedJob.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LoggedJobCol_evtLoaded() Handles Me.evtLoaded 
