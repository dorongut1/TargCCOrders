Partial Public Class ctlc_UserPermissionCol
  ...
  Private Sub ctlc_UserPermissionCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    '_LoadParameters.ColumnsHeaderText.Add(csUserPermission.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_UserPermissionCol_evtLoaded() Handles Me.evtLoaded 
