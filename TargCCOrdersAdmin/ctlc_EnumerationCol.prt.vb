Partial Public Class ctlc_EnumerationCol
  ...
  Private Sub ctlc_EnumerationCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csEnumeration.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csEnumeration.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_EnumerationCol_evtLoaded() Handles Me.evtLoaded 
