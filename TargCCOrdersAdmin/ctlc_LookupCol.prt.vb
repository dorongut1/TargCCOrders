Partial Public Class ctlc_LookupCol
  ...
  Private Sub ctlc_LookupCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLookup.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLookup.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LookupCol_evtLoaded() Handles Me.evtLoaded 
