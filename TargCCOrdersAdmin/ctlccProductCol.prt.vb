Partial Public Class ctlccProductCol
  ...
  Private Sub ctlccProductCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(clsProduct.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(clsProduct.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlccProductCol_evtLoaded() Handles Me.evtLoaded 
