Partial Public Class ctlc_SystemAuditCol
  ...
  Private Sub ctlc_SystemAuditCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csSystemAudit.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csSystemAudit.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_SystemAuditCol_evtLoaded() Handles Me.evtLoaded 
