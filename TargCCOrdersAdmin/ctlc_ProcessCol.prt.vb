Partial Public Class ctlc_ProcessCol
  ...
  Private Sub ctlc_ProcessCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csProcess.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csProcess.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_ProcessCol_evtLoaded() Handles Me.evtLoaded 
