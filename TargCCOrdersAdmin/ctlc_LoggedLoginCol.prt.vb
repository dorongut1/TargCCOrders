Partial Public Class ctlc_LoggedLoginCol
  ...
  Private Sub ctlc_LoggedLoginCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csLoggedLogin.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csLoggedLogin.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_LoggedLoginCol_evtLoaded() Handles Me.evtLoaded 
