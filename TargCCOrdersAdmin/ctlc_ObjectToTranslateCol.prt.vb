Partial Public Class ctlc_ObjectToTranslateCol
  ...
  Private Sub ctlc_ObjectToTranslateCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csObjectToTranslate.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csObjectToTranslate.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_ObjectToTranslateCol_evtLoaded() Handles Me.evtLoaded 
