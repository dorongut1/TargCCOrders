Partial Public Class ctlc_ObjectTranslationCol
  ...
  Private Sub ctlc_ObjectTranslationCol_evtBeforeLoad() Handles Me.evtBeforeLoad 
    'Sample 
    ...
    'Hide columns 
    '_LoadParameters.ColumnsHide.Add(csObjectTranslation.enmProperty.ID) 
 
    'Change Header Texts as (if) needed 
    '_LoadParameters.ColumnsHeaderText.Add(csObjectTranslation.enmProperty.MainText, "The Main Text") 
  ...
  'Private Sub ctlc_ObjectTranslationCol_evtLoaded() Handles Me.evtLoaded 
