Public Class csRole
  ...
  Private _BaseRoleID As Long
  Private _BaseRole As csRole
  Private _BaseRoleText As String
  Private _Tag As String
  Private _Permissions As csPermissionCol
  Private _RolesForBaseRoles As csRoleCol
  Private _Users As csUserCol
  ...
  Public Property [Name]() As String
    ...
    End Set
  End Property
  Public Property [BaseRoleID]() As Long
    Get
      Return Me._BaseRoleID
    End Get
    Set(ByVal value As Long)
      If Me._BaseRoleID <> value Then 
        bccStatus = clsEnums.enmObjectStatus.Dirty 
        Me._BaseRoleID = value 
      End If 
    End Set
  End Property
  Public Property [BaseRole]() As csRole
    Get
      Return Me._BaseRole
    End Get
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Property BaseRoleText() As String
    Get
      Return Me._BaseRoleText
    End Get
    Set(ByVal value As String)
      Me._BaseRoleText = value
    End Set
  End Property
  ''' <summary> 
  ...
  Public Property [Tag]() As String
    ...
    End Set
  End Property
  Public Property [Permissions]() As csPermissionCol
    Get
      Return Me._Permissions
    End Get
    Set(ByVal value As csPermissionCol)
      Me._Permissions = value
    End Set
  End Property
  Public Property [RolesForBaseRoles]() As csRoleCol
    Get
      Return Me._RolesForBaseRoles
    End Get
    Set(ByVal value As csRoleCol)
      Me._RolesForBaseRoles = value
    End Set
  End Property
  Public Property [Users]() As csUserCol
    Get
      Return Me._Users
    End Get
    Set(ByVal value As csUserCol)
      Me._Users = value
    End Set
  End Property
  ...
  Public Overrides Function ToString() As String 
    ...
    If _BaseRoleID <> 0 Then pValue.Append("BaseRoleID='" & _BaseRoleID.ToString() & "' ‡ ") 
    If _BaseRoleText <> "" Then pValue.Append("BaseRoleText='" & _BaseRoleText & "' ‡ ") 
  ...
  Public Overrides Function ToCSV(Optional ByVal vWithTexts As Boolean = False) As String 
    ...
    pCSV.Append("," & _BaseRoleID.ToString() & "") 
    If vWithTexts Then pCSV.Append($",""{ccHelper.StringForCSV(_BaseRoleText)}""") 
  ...
  Public Sub New(ByVal vcsRole As csRole)
    MyBase.New()
    CreateEmpty()
    AssignValues(vcsRole) 
  End Sub
  
  Public Sub New( 
      vID As Long _ 
    , Optional vName As String = "" _ 
    , Optional vBaseRoleID As Long = 0 _ 
    , Optional vBaseRoleText As String = "" _ 
    ...
    _ID = vID 
    _Name = vName 
    _BaseRoleID = vBaseRoleID 
    _BaseRoleText = vBaseRoleText 
    _Tag = vTag 
  ...
  'Inherited Gets 
  ''' <summary> 
  ''' This satisfies an interface requirement. All TargCCEntities have this function. It gets the Role by PrimaryKey (ID) 
  ''' </summary> 
  ...
  Public Overrides Function GetByPrimaryKey(ByVal vPrimaryKeyValue As Long, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_GetByPrimaryKey", vRequester) 
    ...
    Catch ex As Exception 
      pFault = New clsFault 
      pFault.LogException(57, ex, pFunctionParameters, "TRGT-Role-151224_0844", vRequester) 
    End Try 
  ...
  End Enum 
  ''' <summary> 
  ''' This satisfies an interface requirement. All TargCCEntities have this function. It gets the Role by the chosen parameters. This function may be a bit slower than accessing the Role's GetBy... directly 
  ''' </summary> 
  ...
  Public Overrides Function GetByParameters(ByVal vParametersType As [Enum], ByVal vParameters As List(Of Object), ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_GetByParameters", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Try 
      Select Case pGetByOptions 
        ...
        Case Else 
          pFault = New clsFault 
          pFault.LogFreeTextFault(56, "", pFunctionParameters, "TRGT-Role-151223_1715", vRequester) 
      End Select 
    Catch ex As Exception 
      pFault = New clsFault  
      pFault.LogException(57, ex, pFunctionParameters, "TRGT-Role-151223_1716", vRequester)  
    End Try  
  ...
  Public Function GetByID(ByVal vID As Long, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_GetByID", vRequester) 
    If Not pFault.isOK Then Return pFault 
    
    CreateEmpty() 
    
    If vID = 0 Then 
      If vMustExist Then Return pFault.LogFreeTextFault(70, $"Role not found for GetByID, since its value is 0", pFunctionParameters, "TRGT-Role-210927-1527", vRequester, vAdditionalMessageToUser:=$"Role not found") 
      pFault.SetOK() 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      pFault = LoadMeFromDBCache(MyController.DBCache.ccRoleCol.FindByID(vID), vRequester) : If pFault.isOK = False Then Return pFault
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RoleGetByID" 
      ...
      Try 
        ...
        If (vMustExist AndAlso Me.IsEmpty) Then pFault.LogFreeTextFault(70, $"Role not found for GetByID. See FunctionParameters for values", pFunctionParameters, "TRGT-Role-210625-0950", vRequester, vAdditionalMessageToUser:=$"Role not found") 
      Catch ex As Exception 
        ...
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090623-1648", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Function GetByName(ByVal vName As String, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_GetByName", vRequester) 
    If Not pFault.isOK Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      pFault = LoadMeFromDBCache(MyController.DBCache.ccRoleCol.FindByName(vName), vRequester) : If pFault.isOK = False Then Return pFault
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RoleGetByName" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.NVarChar, 50).Value = (vName) 
        pLastReadVariableName = "WithParents" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
        ...
        'Execute query 
        pFault = ccDAL.ExecuteQuery(pCommandText, pDALParameters, vRequester, Me) : If Not pFault.isOK Then Return pFault 
        If (vMustExist AndAlso Me.IsEmpty) Then pFault.LogFreeTextFault(70, $"Role not found for GetByName. See FunctionParameters for values", pFunctionParameters, "TRGT-Role-210625-0950", vRequester, vAdditionalMessageToUser:=$"Role not found") 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090623-1648", vRequester) 
      End Try 
  ...
  Public Function AddUpdate(vRequester As clsRequester, Optional vReload As Boolean = True) As clsFault Implements ITargCCEntityAddable.AddUpdate 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleUpdate, "csRole_AddUpdate", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    If _ID <> 0 Then 
      'Invalid EntityID received for the operation 
      Return pFault.LogFreeTextFault(58, "Received and ID of " & _ID, pFunctionParameters, "TRGT-Role-151227-1738", vRequester) 
    Else 
  ...
  Public Function EditUpdate(vRequester As clsRequester, Optional vReload As Boolean = True) As clsFault Implements ITargCCEntityEditable.EditUpdate 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleUpdate, "csRole_EditUpdate", vRequester) 
    If pFault.isOK = False Then Return pFault 
  ...
  ''' <summary> 
  ''' This updates the Role. If there are parents or children in the Role, they are NOT updated.  
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleUpdate, "csRole_Update", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Dim pRole As New csRole(_WithParents) 
    If Me.isEqual(pRole) Then 
      Return pFault.LogFreeTextFault(53, "Object is 'New' - contains no data ", pFunctionParameters, "TRGT-Role-100113-1638", vRequester) 
    End If 
 
    If _IsTruncated Then 
      Return pFault.LogFreeTextFault(57, "Object is Truncated", pFunctionParameters, "TRGT-Role-240611-135714", vRequester) 
    End If 
 
    Dim pCommandText As String = "c_RoleUpdate"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      Dim pCachedRole As csRole 
      If _ID = 0 Then 
        pCachedRole = New csRole(_WithParents) 
        'get last ID 
        Dim pRoleCol As csRoleCol = MyController.DBCache.ccRoleCol.Clone() 
        If pRoleCol.Count = 0 Then 
          _ID = 1 
        Else 
          pRoleCol.SortByID() 
          Dim pLastID As Long = pRoleCol(pRoleCol.Count - 1).ID
          _ID = pLastID + 1 
        End If 
        bPrimaryKey = _ID 
        MyController.DBCache.ccRoleCol.Add(pCachedRole) 
      Else  
        pCachedRole = MyController.DBCache.ccRoleCol.FindByID(_ID) 
      End If 
      pCachedRole.AssignValues(Me) 
      'Save File 
      pFault = MyController.DBCache.SaveData(MyController.DBCache.ccRoleCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
        ...
        pLastReadVariableName = "Name" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.NVarChar, 50).Value = ccHelper.ObjectNullable(_Name) 
        pLastReadVariableName = "BaseRoleID" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.BigInt).Value = ccHelper.ForeignKeyLongNullable(_BaseRoleID, False) 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            ...
            bPrimaryKey = pID 
            If pID = 0 Then 
              pFault.LogFreeTextFault(51, "ID returned is 0!", pFunctionParameters, "TRGT-Role-151114-1147", vRequester) 
            End If 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-Role-160324-1700", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090623-1809", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
    ...
    If vReload = True Then 
      ...
      'Parents 
      Dim pBaseRole As csRole = _BaseRole 
      
      'Children 
      Dim pPermissions As csPermissionCol = _Permissions 
      Dim pRolesForBaseRoles As csRoleCol = _RolesForBaseRoles 
      Dim pUsers As csUserCol = _Users 
      ...
      If _WithParents <> clsEnums.enmLoadParent.EntireObject Then 
        If Not pBaseRole Is Nothing Then _BaseRole = pBaseRole 
      End If 
      
      'Children 
      If Not pPermissions Is Nothing Then _Permissions = pPermissions 
      If Not pRolesForBaseRoles Is Nothing Then _RolesForBaseRoles = pRolesForBaseRoles 
      If Not pUsers Is Nothing Then _Users = pUsers 
  ...
  Public Function Delete(ByVal vRequester As clsRequester) As clsFault Implements ITargCCEntityDeletable.Delete 
    Dim pFunctionParameters As String = String.Format("Role.ID={0}", _ID)
    Dim pFault As clsFault
 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRole_Delete", vRequester) 
    If Not pFault.isOK Then Return pFault 
    ...
    Dim pCommandText As String = "c_RoleDelete" 
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      MyController.DBCache.ccRoleCol.Remove(MyController.DBCache.ccRoleCol.FindByID(_ID)) 
      'Save File 
      pFault = MyController.DBCache.SaveData(MyController.DBCache.ccRoleCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      ...
      Try 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            ...
            If pID <> -1 Then pFault.LogFreeTextFault(51, "I expected to get -1 back!", pFunctionParameters, "TRGT-Role-151114-1147", vRequester) 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-Role-160324-1700", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090623-1813", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If
  ...
  Public Shared Function DeleteByID(vID As Long, vRequester As clsRequester) As clsFault 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRole_DeleteByID", vRequester) 
    If Not pFault.isOK Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      MyController.DBCache.ccRoleCol.Remove(MyController.DBCache.ccRoleCol.FindByID(vID)) 
      'Save File  
      pFault = MyController.DBCache.SaveData(MyController.DBCache.ccRoleCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      ...
      Try 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            pTargCCReader.Read() 
            Dim pID As Integer = ccHelper.ToInteger(pTargCCReader(0)) 
            If pID <> -1 Then pFault.LogFreeTextFault(51, "I expected to get -1 back!", pFunctionParameters, "TRGT-Role-231207-0845", vRequester) 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-Role-231207-0844", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-231207-0843", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If 
  ...
  ''' <summary>
  ''' Fills the Role's Permission collection (1 to Many relationship)
  ''' </summary>
  ''' <param name="vRequester"></param>
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FillPermissions(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    Dim pFault As New clsFault
    
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_FillPermissions", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    _Permissions = New csPermissionCol(_WithParents)
    ...
    pFault = _Permissions.FillByRoleID(_ID, vRequester, vHowMany, vDir) : If pFault.isOK = False Then Return pFault
    RaiseEvent evtAfterGet()
    RaiseEvent evtAfterGetWithRequester(vRequester, pFault) 
    Return pFault
  End Function
  ''' <summary>
  ''' Fills the Role's Role collection (1 to Many relationship)
  ''' </summary>
  ''' <param name="vRequester"></param>
  ''' <param name="vHowMany"></param>
  ''' <param name="vDir"></param>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FillRolesForBaseRoles(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    Dim pFault As New clsFault
    
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_FillRolesForBaseRoles", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    _RolesForBaseRoles = New csRoleCol(_WithParents)
    ...
    pFault = _RolesForBaseRoles.FillByBaseRoleID(_ID, vRequester, vHowMany, vDir) : If pFault.isOK = False Then Return pFault
    RaiseEvent evtAfterGet()
    RaiseEvent evtAfterGetWithRequester(vRequester, pFault) 
    Return pFault
  End Function
  ''' <summary>
  ''' Fills the Role's User collection (1 to Many relationship)
  ''' </summary>
  ''' <param name="vRequester"></param>
  ''' <param name="vHowMany"></param>
  ''' <param name="vDir"></param>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FillUsers(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    Dim pFault As New clsFault
    
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRole_FillUsers", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    _Users = New csUserCol(_WithParents)
    ...
    pFault = _Users.FillByRoleID(_ID, vRequester, vHowMany, vDir) : If pFault.isOK = False Then Return pFault
    RaiseEvent evtAfterGet()
    RaiseEvent evtAfterGetWithRequester(vRequester, pFault) 
    Return pFault
  End Function
  ...
  Public Overrides Function isEqual(ByVal vTargCCEntityToTest As ITargCCEntity) As Boolean 
    If Not (TypeOf (vTargCCEntityToTest) Is csRole) Then Return False 
    Dim pRoleToTest As csRole = CType(vTargCCEntityToTest, csRole) 
    Return isEqual(pRoleToTest) 
  End Function 
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Overloads Function isEqual(ByVal vRoleToTest As csRole) As Boolean
    With vRoleToTest
      If _ID <> .ID Then Return False
      If _Name <> .Name Then Return False
      If _BaseRoleID <> .BaseRoleID Then Return False
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function Clone() As csRole
    Dim pClone As New csRole(Me)
    Return pClone
  End Function
  ...
  Friend Overrides Function LoadDataRow(ByVal vDataRow As DataRow, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try : vDataRow("ID") = _ID : Catch ex As Exception : Return pFault.LogException(ex, "ID", "TRGT-Role-130316-0852", vRequester) : End Try 
    Try : vDataRow("Name") = _Name : Catch ex As Exception : Return pFault.LogException(ex, "Name", "TRGT-Role-130316-0852", vRequester) : End Try 
    Try : vDataRow("BaseRoleID") = _BaseRoleID : Catch ex As Exception : Return pFault.LogException(ex, "BaseRoleID", "TRGT-Role-130316-0852", vRequester) : End Try 
  ...
  Public Overrides Function CreateXML(ByRef rXML As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-130515-1236", vRequester) 
    End Try 
  ...
  Public Overrides Function LoadXML(ByVal vXML As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      Dim pRole As csRole = CType(pXmlSerializer.Deserialize(pStreamReader), csRole) 
      AssignValues(pRole) 
      pFault.SetOK() 
    Catch ex As Exception 
      CreateEmpty() 
      pFault.LogException(ex, vXML, "TRGT-Role-130515-1230", vRequester) 
    End Try 
    ...
    Try 
      Using pMemoryStream As New System.IO.MemoryStream() 
        Using pBinaryWriter As New System.IO.BinaryWriter(pMemoryStream) 
          ...
          'BaseRoleID 
          pBinaryWriter.Write(_BaseRoleID) 
          'BaseRole 
          If _BaseRole IsNot Nothing Then 
            pObjectBytes = _BaseRole.CreateByteArray(rFault, vRequester) : If Not rFault.isOK Then Exit Try 
          ...
          End If 
          If _BaseRoleText Is Nothing Then pHasValue = False Else pHasValue = True 
          pBinaryWriter.Write(pHasValue) 
          If pHasValue = True Then pBinaryWriter.Write(_BaseRoleText) 
          'Tag 
...
          pBinaryWriter.Write(bDateAdded.Ticks) 
          ...
          If _Permissions IsNot Nothing Then 
            pObjectBytes = _Permissions.CreateByteArray(rFault, vRequester) : If Not rFault.isOK Then Exit Try 
            pLength = pObjectBytes.Length 
          Else 
            pLength = 0 
          End If 
          ...
          'RolesForBaseRoles  
          If _RolesForBaseRoles IsNot Nothing Then 
            pObjectBytes = _RolesForBaseRoles.CreateByteArray(rFault, vRequester) : If Not rFault.isOK Then Exit Try 
            pLength = pObjectBytes.Length 
          Else 
            pLength = 0 
          End If 
          ...
          If _Users IsNot Nothing Then 
            pObjectBytes = _Users.CreateByteArray(rFault, vRequester) : If Not rFault.isOK Then Exit Try 
            pLength = pObjectBytes.Length 
          Else 
            pLength = 0 
          End If 
      ...
      rFault.SetOK() 
    Catch ex As Exception 
      rFault.LogException(ex, pFunctionParameters, "TRGT-Role-150307-2338", vRequester) 
    End Try 
    ...
    Try 
      ...
      Using pMemoryStream As New System.IO.MemoryStream(vBytes) 
        Using pReader As New System.IO.BinaryReader(pMemoryStream) 
          ...
          'BaseRoleID 
          _BaseRoleID = pReader.ReadInt64 
          'BaseRole 
          pLength = pReader.ReadInt32 
          If pLength > 0 Then 
            pObjectBytes = pReader.ReadBytes(pLength) 
            _BaseRole = New csRole(pObjectBytes, rFault, vRequester) : If Not rFault.isOK Then Exit Try 
          End If 
          pHasValue = pReader.ReadBoolean 
          If pHasValue = True Then _BaseRoleText = pReader.ReadString 
          'Tag 
          pHasValue = pReader.ReadBoolean 
...
          'bDateAdded 
          ...
          If pLength > 0 Then 
            pObjectBytes = pReader.ReadBytes(pLength) 
            _Permissions = New csPermissionCol(pObjectBytes, rFault, vRequester) : If Not rFault.isOK Then Exit Try 
          End If 
          'RolesForBaseRoles 
          pLength = pReader.ReadInt32 
          If pLength > 0 Then 
            pObjectBytes = pReader.ReadBytes(pLength) 
            _RolesForBaseRoles = New csRoleCol(pObjectBytes, rFault, vRequester) : If Not rFault.isOK Then Exit Try 
          End If 
          'Users 
          pLength = pReader.ReadInt32 
          If pLength > 0 Then 
            pObjectBytes = pReader.ReadBytes(pLength) 
            _Users = New csUserCol(pObjectBytes, rFault, vRequester) : If Not rFault.isOK Then Exit Try 
          End If 
          pReader.Close() 
        End Using 
        pMemoryStream.Close() 
    ...
    Catch ex As Exception 
      CreateEmpty() 
      rFault.LogException(ex, "", "TRGT-Role-150307-2339", vRequester) 
    End Try 
    bPrimaryKey = _ID 
    CreateDefaultDesignation() 
  End Sub 
  ...
  Public Overrides Function CreateJSON(ByRef rJSON As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-190720-1443", vRequester) 
    End Try 
  ...
  Public Overrides Function LoadJSON(ByVal vJSON As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      Dim pRole As csRole = Newtonsoft.Json.JsonConvert.DeserializeObject(Of csRole)(vJSON, pSettings) 
      AssignValues(pRole) 
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-190720-1443", vRequester) 
  ...
  ''' </summary>
  ''' <remarks></remarks>
  Private Sub AssignValues(ByVal vRole As csRole)
    With vRole
      _ID = .ID 
      _Name = .Name 
      _BaseRoleID = .BaseRoleID 
      If .BaseRole IsNot Nothing Then 
        _BaseRole = .BaseRole.Clone() 
      End If 
      _BaseRoleText = .BaseRoleText 
      _Tag = .Tag 
  ...
  Public Function LoadParents(ByVal vRequester As clsRequester) As clsFault
    ...
    'Foreign Parent
    If _BaseRoleID > 0 Then
      _BaseRole = New csRole()
      pFault = _BaseRole.GetByID(_BaseRoleID, vRequester, True)
      If pFault.isOK = False Then Return pFault
      _BaseRoleText = _BaseRole.DefaultDesignation 
    End If
...
#Region "Load Entity" 
  Friend Function LoadMeFromIDataReader(vReader As IDataReader, vRequester As clsRequester) As clsFault Implements ITargCCDataReaderUser.LoadMeFromIDataReader 
    ...
    Try
      ...
      pLastReadVariableName = "BaseRoleID" 
      If Not vReader.IsDBNull(2) Then _BaseRoleID = vReader.GetInt64(2)
      pLastReadVariableName = "bDateAdded" 
      If Not vReader.IsDBNull(3) Then bDateAdded = vReader.GetDateTime(3)   
      If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
        pLastReadVariableName = "BaseRoleText" 
        If Not vReader.IsDBNull(4) Then _BaseRoleText = vReader.GetString(4) 
    ...
    Catch ex As Exception
      If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090624-1143", vRequester)
    End Try
  ...
  Private Function LoadMeFromDBCache(ByVal vCachedRole As csRole, ByVal vRequester As clsRequester) As clsFault 
    Dim pFunctionParameters As String = "" 
    Dim pFault As New clsFault 
    ...
    Try 
      ...
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-121122-1607", vRequester) 
    End Try 
...
Public Class csRoleCol
  Inherits cTargCCCollection(Of csRole)
  ...
  'Support for FindBys
  Private _SortedDictionaryForFindByID As Dictionary(Of Long, csRole) 
  Private _RecreateDictionaryForFindByID As Boolean 
  Private _SortedDictionaryForFindByName As Dictionary(Of String, csRole) 'bigger, but safer, in case ID = 0 
  Private _RecreateDictionaryForFindByName As Boolean 
  Private Function CreateKeyForFindByName(ByVal vRole As csRole) As String 
    With vRole 
      Return .Name
    End With 
  End Function 
  ...
  Public Overrides Function ToCSV(Optional ByVal vWithTexts As Boolean = False) As String 
    ...
    pCSVTitle.Append(",""BaseRoleID" & pDbCode & """") 
    If vWithTexts Then pCSVTitle.Append(",""BaseRole (Text)""") 
    If Not vWithTexts Then 
  ...
  Public Overloads Sub Add(ByVal vRole As csRole) 
    ...
    End SyncLock 
  End Sub 
  Public Overloads Sub Insert(ByVal vIndex As Integer, ByVal vRole As csRole) 
    SyncLock _CollectionLock 
      MyBase.Insert(vIndex, vRole) 
      _RecreateDictionaryForFindByID = True 
      _RecreateDictionaryForFindByName = True 
    End SyncLock 
  End Sub 
  Public Overloads Sub AddRange(ByVal vRoleCol As csRoleCol) 
    SyncLock _CollectionLock 
      MyBase.AddRange(vRoleCol) 
      _RecreateDictionaryForFindByID = True 
      _RecreateDictionaryForFindByName = True 
    End SyncLock 
  End Sub 
  Public Overloads Sub RemoveAt(ByVal vIndex As Integer) 
    ...
    End SyncLock 
  End Sub 
  Public Overloads Sub Remove(ByVal vRole As csRole) 
    SyncLock _CollectionLock 
      MyBase.Remove(vRole) 
      _RecreateDictionaryForFindByID = True 
      _RecreateDictionaryForFindByName = True 
  ...
  Private Sub LoadIDs() 
    ...
    SyncLock _CollectionLock 
      ...
      Dim pTempDictionary As New Dictionary(Of Long, csRole) 
      
      For Each lRole In Me 
        If lRole.IsEmpty OrElse pTempDictionary.ContainsKey(lRole.ID) Then 
          'Not Unique or no ID 
          Continue For 
        End If 
        Try 
          pTempDictionary.Add(lRole.ID, lRole) 
        Catch ex As Exception 
          Dim pFault As New clsFault 
          pFault.LogException(ex, lRole.ToString, "TRGT-Role-260111-154655", Nothing) 'Log it 
          Throw New Exception("Failed pTempDictionary for _SortedDictionaryForFindByID:" & ex.Message & ", Role:" & lRole.ToString() & ", TRGT-Role-260111-154657") 'Send it up the line 
        End Try 
      Next 
  ...
  Private Sub LoadNames() 
    ...
    SyncLock _CollectionLock 
      ...
      Dim pTempDictionary As New Dictionary(Of String, csRole)(StringComparer.OrdinalIgnoreCase) 
      
      For Each lRole In Me 
        Try 
          Dim pName As String = CreateKeyForFindByName(lRole) 
          If String.IsNullOrEmpty(pName.Replace("|", "")) Then Continue For 
          If Not (pTempDictionary.ContainsKey(pName)) Then 
            pTempDictionary.Add(pName, lRole) 
        ...
        Catch ex As Exception 
          Dim pFault As New clsFault 
          pFault.LogException(ex, lRole.ToString, "TRGT-Role-260111-154655", Nothing) 'Log it 
          Throw New Exception("Failed pTempDictionary for _SortedDictionaryForFindByName:" & ex.Message & ", Role:" & lRole.ToString() & ", TRGT-Role-260111-154657") 'Send it up the line 
        End Try 
      Next 
  ...
  Public Sub TruncateStrings(Optional pTruncateLength As Integer = 50) 
    ...
    For Each lRole As csRole In Me 
      lRole.TruncateStrings(pTruncateLength) 
    Next 
  ...
  End Enum 
  ''' <summary> 
  ''' This satisfies an interface requirement. All TargCCCollections have this function. It gets the Roles by the chosen parameters. This function may be a bit slower than accessing the Role's FillBy... directly 
  ''' </summary> 
  ...
  Public Overrides Function FillByParameters(ByVal vWhichParameterCombination As [Enum], ByVal vParameters As List(Of Object), ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByParameters", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Try 
      Select Case pGetByOptions 
        ...
        Case enmFillByParameterCombination.BaseRoleID 
          pFault = FillByBaseRoleID(ccHelper.ToLong(vParameters(0)), vRequester, vHowMany, vDir) 
        Case Else 
          pFault = New clsFault 
          pFault.LogFreeTextFault(56, "", pFunctionParameters, "TRGT-Role-151223_1715", vRequester) 
      End Select 
  ...
  Public Overrides Function Fill(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_Fill", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      Dim pRolesCached As csRoleCol = MyController.DBCache.ccRoleCol.Clone() 
      pRolesCached.SortByID() : If vDir = clsEnums.enmFillDirection.DESC Then pRolesCached.Reverse() 
      If vHowMany > 0 AndAlso pRolesCached.Count > vHowMany Then 
        Dim tmp As New csRoleCol 
        For i = 0 To vHowMany - 1 
          tmp.Add(pRolesCached(i)) 
        Next 
        pRolesCached = tmp 
      End If 
      pFault = LoadMeFromDBCache(pRolesCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFill"
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090624-1625", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  ''' <summary>
  ''' Gets a collection of all the items for a specific BaseRoleID, or a sub-collection defined by HowMany and Direction. To append to an existing collection, set vAppend to true (default is false)
  ''' </summary>
  ''' <param name="vHowMany">How Many (sorted by ID) - 0 for all</param>
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FillByBaseRoleID(ByVal vBaseRoleID As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    Dim pFunctionParameters As String = String.Format("BaseRoleID={0}", vBaseRoleID)
    Dim pFault As New clsFault
 
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByBaseRoleID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      Dim pRolesCached As csRoleCol = MyController.DBCache.ccRoleCol.CloneByBaseRoleID(vBaseRoleID)
      pFault = LoadMeFromDBCache(pRolesCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillByBaseRoleID" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        'set parameters 
        pLastReadVariableName = "BaseRoleID" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.BigInt).Value = ccHelper.ForeignKeyLongNullable(vBaseRoleID, False) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090624-1702", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Function FillByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByBoundedID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      Dim pRolesCached As csRoleCol = MyController.DBCache.ccRoleCol.CloneByBoundedID(vIDFrom, vIDTo)
      pFault = LoadMeFromDBCache(pRolesCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
        Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillByBoundedID" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-151113-1405", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Function FillByBoundedName(ByVal vNameFrom As String, ByVal vNameTo As String, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByBoundedName", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.ccRoleCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.ccRoleCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load csRoleCol failed: " & pResponse) 
      Dim pRolesCached As csRoleCol = MyController.DBCache.ccRoleCol.CloneByBoundedName(vNameFrom, vNameTo)
      pFault = LoadMeFromDBCache(pRolesCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
        Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillByBoundedName" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pDALParameters.Add("bndNameFrom", ccDAL.enmSQLDataType.NVarChar, 50).Value = (vNameFrom) 
        pLastReadVariableName = "NameTo" 
        pDALParameters.Add("bndNameTo", ccDAL.enmSQLDataType.NVarChar, 50).Value = (vNameTo) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
  ...
  Public Function FillByWildCardName(ByVal vName As String, ByVal vNameWildcardType As clsEnums.enmWildCardType, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByWildCardName", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("FillByWildCardOrderingCode has not been handled yet locally", pFunctionParameters, "TRGT-Role-121122-2008", vRequester) 
    Else 
        Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillByWildCardName" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pDALParameters.Add("wldName", ccDAL.enmSQLDataType.NVarChar, 50).Value = (pWCName) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
  ...
  Public Function FillByListOfID(vIDs As List(Of Long), vRequester As clsRequester, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillByListOfID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    For Each l In vIDs 
      ...
      Dim lRole As New csRole() 
      pFault = lRole.GetByID(l, vRequester) : If Not pFault.isOK Then Return pFault 
      If Not lRole.IsEmpty Then Me.Add(lRole) 
    Next 
 
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController 
      Dim pRoles As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pRoles, "csRoleCol_Fill", vRequester) : If Not pFault.isOK Then Return pFault 
      If pRoles IsNot Nothing AndAlso Me.Count <> pRoles.Count Then FillFromListOfITargCCEntity(pRoles) 
    End If 
  ...
  Public Overrides Function FillOnTheFly(ByVal vParameters As Dictionary(Of System.Enum, Object), ByVal vRequester As clsRequester) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillOnTheFly", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If vParameters.ContainsKey(enmFillOnTheFlyParameters.BaseRoleID) Then pObj = vParameters(enmFillOnTheFlyParameters.BaseRoleID) : If pObj IsNot Nothing Then pBaseRoleID = ccHelper.ToLong(pObj) 
  ...
  Public Overloads Function FillOnTheFly( _
        ...
        , ByVal vBaseRoleID As Nullable(Of Long) _
    ...
    Dim pFunctionParameters As String = String.Format("IDFrom={0}, IDTo={1}, Name={2}, NameWildcardType={3}, BaseRoleID={4}", vIDFrom, vIDTo, vName, vNameWildcardType.FastToString(), vBaseRoleID)
    Dim pFault As New clsFault
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      'Return pFault.LogFreeTextFault("FillOnTheFly has not been handled yet locally", pFunctionParameters, "TRGT-Role-121122-2008", vRequester) 
      Dim pRolesCached As csRoleCol = MyController.DBCache.ccRoleCol.Clone() 
      Dim pRolesToUse As New csRoleCol() 
      For Each l In pRolesCached 
        ...
        If Not String.IsNullOrEmpty(vName) Then 
          ...
          End If 
        End If 
        If vBaseRoleID.HasValue Then 
          If l.BaseRoleID <> vBaseRoleID.Value Then Continue For 
        End If 
        pRolesToUse.Add(l) 
      Next 
      pRolesToUse.SortByID() : If vDir = clsEnums.enmFillDirection.DESC Then pRolesToUse.Reverse() 
      If vHowMany > 0 AndAlso pRolesToUse.Count > vHowMany Then 
        Dim tmp As New csRoleCol 
        For i = 0 To vHowMany - 1 
          tmp.Add(pRolesToUse(i)) 
        Next 
        pRolesToUse = tmp 
      End If 
      pFault = LoadMeFromDBCache(pRolesToUse, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillOnTheFly" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pLastReadVariableName = "Name" 
        pDALParameters.Add("wldName", ccDAL.enmSQLDataType.NVarChar, 50).Value = ccHelper.ObjectNullable(pWCName) 
        pLastReadVariableName = "BaseRoleID" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.BigInt).Value = ccHelper.ObjectNullable(vBaseRoleID) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090303-1658", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Overrides Function FillSumOnTheFly(ByVal vParameters As Dictionary(Of [Enum], Object), ByVal vRequester As clsRequester) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_FillSumOnTheFly", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If vParameters.ContainsKey(enmFillOnTheFlyParameters.NameWildcardType) Then pObj = vParameters(enmFillOnTheFlyParameters.NameWildcardType) : If pObj IsNot Nothing Then pNameWildcardType = CType(pObj, clsEnums.enmWildCardType) 
    If vParameters.ContainsKey(enmFillOnTheFlyParameters.BaseRoleID) Then pObj = vParameters(enmFillOnTheFlyParameters.BaseRoleID) : If pObj IsNot Nothing Then pBaseRoleID = ccHelper.ToLong(pObj) 
    If vParameters.ContainsKey(enmFillSumOnTheFlyParameters.GroupByBaseRoleID) Then pObj = vParameters(enmFillSumOnTheFlyParameters.GroupByBaseRoleID) : If pObj IsNot Nothing Then pGroupByBaseRoleID = CBool(pObj) 
     
    pFault = FillSumOnTheFly(
          pIDFrom, pIDTo _
        , pName, pNameWildcardType _
        , pBaseRoleID _
        , pGroupByBaseRoleID _
  ...
  Public Overloads Function FillSumOnTheFly( _
        ...
        , ByVal vName As String, ByVal vNameWildcardType As clsEnums.enmWildCardType _
        , ByVal vBaseRoleID As Nullable(Of Long) _
        , ByVal vGroupByBaseRoleID As Boolean _
        , ByVal vRequester As clsRequester) As clsFault
    Dim pFunctionParameters As String = String.Format("IDFrom={0}, IDTo={1}, Name={2}, NameWildcardType={3}, BaseRoleID={4}, GroupByBaseRoleID={5}", vIDFrom, vIDTo, vName, vNameWildcardType.FastToString(), vBaseRoleID, vGroupByBaseRoleID)
    Dim pFault As New clsFault
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("FillSumOnTheFly has not been handled yet locally", pFunctionParameters, "TRGT-Role-121122-2008", vRequester) 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "c_RolesFillSumOnTheFly" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.BigInt).Value = ccHelper.ObjectNullable(vBaseRoleID) 
        pLastReadVariableName = "BaseRoleID" 
        pDALParameters.Add("GroupByBaseRoleID", ccDAL.enmSQLDataType.Bit).Value = vGroupByBaseRoleID
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
  ...
  Public Overloads Sub FillFromArray(ByVal vRoleArray As csRole())
    Me.Clear()
    
    For Each pRole As csRole In vRoleArray
      Me.Add(pRole)
      _Clean.Add(pRole.ID) 
    Next
  End Sub
  ...
  Public Overrides Function FillFromDataTable(ByVal vDataTable As DataTable, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      For Each pRow As DataRow In vDataTable.Rows 
        Dim pRole As New csRole(pRow, vRequester, _WithParents) 
        Me.Add(pRole) 
        _Clean.Add(pRole.ID) 
      Next 
      pFault.SetOK() 
    Catch ex As Exception 
      Return pFault.LogException(ex, "", "TRGT-RoleCol-130315-2118", vRequester) 
    End Try 
  ...
  Public Overrides Function CreateXML(ByRef rXML As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      rXML = MyStringBuilder.ToString() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-130515-1300", vRequester) 
    End Try 
  ...
  Public Overrides Function FillFromXML(ByVal vXML As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      Dim pXmlSerializer As New System.Xml.Serialization.XmlSerializer(pType) 
      Dim pStreamReader As New IO.StringReader(vXML) 
      Dim pRoles As csRoleCol = CType(pXmlSerializer.Deserialize(pStreamReader), csRoleCol) 
      For Each pRole As csRole In pRoles 
        Me.Add(pRole) 
        _Clean.Add(pRole.ID) 
      Next 
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, vXML, "TRGT-Role-130515-1329", vRequester) 
    End Try 
  ...
  Public Overrides Function LoadJSON(ByVal vJSON As String, ByVal vRequester As clsRequester) As clsFault 
    ...
    Try 
      ...
      Dim pRoles As List(Of csRole) = Newtonsoft.Json.JsonConvert.DeserializeObject(Of List(Of csRole))(vJSON, pSettings) 
      For Each pRole As csRole In pRoles 
        Me.Add(pRole) 
        _Clean.Add(pRole.ID) 
      Next 
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-Role-190720-2059", vRequester) 
    End Try 
    ...
    Try 
      Using pMemoryStream As New System.IO.MemoryStream() 
        Using pBinaryWriter As New System.IO.BinaryWriter(pMemoryStream) 
          ...
          For Each lRole As csRole In Me 
            Dim pByte As Byte() = lRole.CreateByteArray(rFault, vRequester) : If Not rFault.isOK Then Return Nothing 
      ...
      rFault.SetOK() 
    Catch ex As Exception 
      rFault.LogException(ex, pFunctionParameters, "TRGT-Role-150307-2340", vRequester) 
    End Try 
  ...
  Public Overrides Sub LoadByteArray(ByVal vBytes As Byte(), ByRef rFault As clsFault, ByVal vRequester As clsRequester) 
    ...
    Try 
      Using pMemoryStream As New System.IO.MemoryStream(vBytes) 
        Using pReader As New System.IO.BinaryReader(pMemoryStream) 
          ...
          For iCntr As Integer = 0 To pCount - 1 
            ...
            Dim pRole As csRole = New csRole(pReader.ReadBytes(pLength), rFault, vRequester) 
            Me.Add(pRole) : If Not rFault.isOK Then Exit Sub 
            _Clean.Add(pRole.ID) 
          Next 
          pReader.Close() 
        End Using 
      ...
      rFault.SetOK() 
    Catch ex As Exception 
      rFault.LogException(ex, "", "TRGT-Role-150307-2341", vRequester) 
    End Try 
  ...
  Public Overrides Function LoadLookupAndEnumText(ByVal vRequester As clsRequester) As clsFault 
    ...
    For Each pRole As csRole In Me 
      With pRole 
        pFault = pRole.LoadLookupAndEnumText(vRequester) 
  ...
  Public Overrides Function isEqual(vEntitiesToTest As ITargCCCollection) As Boolean 
    If Not (TypeOf (vEntitiesToTest) Is csRoleCol) Then Return False 
    Dim pRoleColToTest As csRoleCol = CType(vEntitiesToTest, csRoleCol) 
    Return isEqual(pRoleColToTest) 
  End Function 
  ...
  ''' This checks if the objects are the same (not if the share the same address), IGNORING the dependants 
  ''' </summary> 
  ''' <param name="vRolesToTest"></param> 
  ''' <returns></returns> 
  Public Overloads Function isEqual(ByVal vRolesToTest As csRoleCol) As Boolean
    If Me.Count <> vRolesToTest.Count Then Return False
    For i As Integer = 0 To Me.Count - 1 
      If Me(i).isEqual(vRolesToTest(i)) = False Then Return False
    Next
    Return True
  End Function
  ...
  Public Overrides Function CloneTargCCCollection() As ITargCCCollection 
    ...
    Dim pRoles As New csRoleCol(_WithParents) 
    If pFilledFromSumOnTheFly Then pRoles._FilledFromSumOnTheFly = True
    
    For Each pRole As csRole In Me 
      Dim pRoleClone As csRole = pRole.Clone() 
      pRoles.Add(pRoleClone) 
      If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
    Next 
    Return pRoles 
  End Function 
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function Clone() As csRoleCol
    Dim pFilledFromSumOnTheFly = _FilledFromSumOnTheFly 
    Dim pRoles As New csRoleCol(_WithParents) 
    If pFilledFromSumOnTheFly Then pRoles._FilledFromSumOnTheFly = True
  ...
  ''' <returns></returns> 
  ''' <remarks></remarks> 
  Public Function CloneByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long) As csRoleCol 
    Dim pRoles As New csRoleCol(_WithParents)  
    pRoles._FilledFromSumOnTheFly = _FilledFromSumOnTheFly 
 
    If _RecreateDictionaryForFindByID = True Then LoadIDs() 
 
    For Each pRole As csRole In _SortedDictionaryForFindByID.Values.ToList() 
      If (pRole.ID > vIDFrom AndAlso pRole.ID <= vIDTo) Then 
        Dim pRoleClone As csRole = pRole.Clone() 
        pRoles.Add(pRoleClone) 
        If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
      End If 
  ...
  ''' <returns></returns> 
  ''' <remarks></remarks> 
  Public Function CloneByBoundedName(ByVal vNameFrom As String, ByVal vNameTo As String) As csRoleCol 
    Dim pRoles As New csRoleCol(_WithParents)  
    pRoles._FilledFromSumOnTheFly = _FilledFromSumOnTheFly 
    ...
    For Each pRole As csRole In _SortedDictionaryForFindByID.Values.ToList() 
      If (pRole.Name > vNameFrom AndAlso pRole.Name <= vNameTo) Then 
        Dim pRoleClone As csRole = pRole.Clone() 
        pRoles.Add(pRoleClone) 
        If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
      End If 
  ...
  ''' <returns></returns> 
  ''' <remarks></remarks> 
  Public Function CloneByWildCardName(ByVal vName As String, ByVal vNameWildcardType As clsEnums.enmWildCardType) As csRoleCol 
    ...
    For Each pRole As csRole In _SortedDictionaryForFindByID.Values.ToList() 
      ...
      If vNameWildcardType = clsEnums.enmWildCardType.After Then 
        If pRole.Name.StartsWith(vName, StringComparison.OrdinalIgnoreCase) Then pAdd = True 
      ElseIf vNameWildcardType = clsEnums.enmWildCardType.Before Then 
        If pRole.Name.EndsWith(vName, StringComparison.OrdinalIgnoreCase) Then pAdd = True 
      ElseIf vNameWildcardType = clsEnums.enmWildCardType.BeforeAndAfter Then 
        If pRole.Name.IndexOf(vName, StringComparison.OrdinalIgnoreCase) > 0 Then pAdd = True 
      ElseIf vNameWildcardType = clsEnums.enmWildCardType.BeforeAndAfterAndBetweenEachLetter Then 
        Dim pLastIndex As Integer = 0 
        pAdd = True 
        For Each p As Char In vName.ToLowerInvariant().ToCharArray 
          Dim pNewIndex As Integer = pRole.Name.ToLowerInvariant().IndexOf(p, pLastIndex) 
          If pNewIndex = -1 Then 
            pAdd = False 
            Exit For 
          Else 
  ...
  Public Function LoadParents(ByVal vRequester As clsRequester) As clsFault
    Dim pFault As New clsFault
    For Each pRole As csRole In Me
      pFault = pRole.LoadParents(vRequester)
      If pFault.isOK = False Then Return pFault
    Next
    _WithParents = clsEnums.enmLoadParent.EntireObject 
    pFault.SetOK()
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FindByID(ByVal vID As Long) As csRole
    If Me.Count = 0 Then Return New csRole 
    ...
    Dim pLocalDict As Dictionary(Of Long, csRole) = _SortedDictionaryForFindByID 
    
    Dim pRole As csRole = Nothing 
    
    ' Add a safety check in case pLocalDict is nothing (though Load{pIndex.Name}s should prevent this)
    If pLocalDict IsNot Nothing Then pLocalDict.TryGetValue(vID, pRole) 
    If pRole IsNot Nothing Then Return pRole Else Return New csRole() 
  End Function
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function FindByName(ByVal vName As String) As csRole
    If Me.Count = 0 Then Return New csRole 
    ...
    ' This ensures that even if LoadIDs replaces the dictionary halfway through 
    ' this function, we are still looking at the valid (older) snapshot.
    Dim pLocalDict As Dictionary(Of String, csRole) = _SortedDictionaryForFindByName 
    
    Dim pRole As csRole = Nothing 
    
    ' Add a safety check in case pLocalDict is nothing (though Load{pIndex.Name}s should prevent this)
    Dim pValueToSearchFor As String = vName
    If pLocalDict IsNot Nothing Then pLocalDict.TryGetValue(pValueToSearchFor, pRole) 
    If pRole IsNot Nothing Then Return pRole Else Return New csRole() 
  End Function
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function CloneByName(ByVal vName As String) As csRoleCol
    Dim pRoles As New csRoleCol(_WithParents) 
    pRoles._FilledFromSumOnTheFly = _FilledFromSumOnTheFly 
    ...
    Dim pTempDist As Dictionary(Of Long, csRole) = _SortedDictionaryForFindByID 
    ...
    If pTempDist IsNot Nothing AndAlso pTempDist.Count > 0 Then 
      'This is faster 
      For Each pRole As csRole In pTempDist.Values
        If pRole.Name.ToLowerInvariant() = vName Then
          Dim pRoleClone As csRole = pRole.Clone()
          pRoles.Add(pRoleClone)
          If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
        End If
    ...
    Else 
      ...
      Dim pList As csRoleCol = Me.Clone() 
      For Each pRole As csRole In pList 
        If pRole.Name.ToLowerInvariant() = vName Then
          Dim pRoleClone As csRole = pRole.Clone()
          pRoles.Add(pRoleClone)
          If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
  ...
  ''' <summary>
  ''' This returns a clone of the collection, including only those object with the defined BaseRoleID
  ''' </summary>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function CloneByBaseRoleID(ByVal vBaseRoleID As Long) As csRoleCol
    Dim pRoles As New csRoleCol(_WithParents) 
    pRoles._FilledFromSumOnTheFly = _FilledFromSumOnTheFly 
    ...
    If pTempDist IsNot Nothing AndAlso pTempDist.Count > 0 Then 
      'This is faster 
      For Each pRole As csRole In pTempDist.Values
        If pRole.BaseRoleID = vBaseRoleID Then
          Dim pRoleClone As csRole = pRole.Clone()
          pRoles.Add(pRoleClone)
          If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
        End If
    ...
    Else 
      'We have no ID, so we can't use it 
      If MyController.LogDetails Then Tools.LogToTextFile.WriteMessage($"In 2nd part of clone for CloneByBaseRoleID with vBaseRoleID of {vBaseRoleID}", "2ndPartOfClone") 
      Dim pList As csRoleCol = Me.Clone() 
      For Each pRole As csRole In pList 
        If pRole.BaseRoleID = vBaseRoleID Then
          Dim pRoleClone As csRole = pRole.Clone()
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Function CloneByTag(ByVal vTag As String) As csRoleCol
    Dim pRoles As New csRoleCol(_WithParents) 
    pRoles._FilledFromSumOnTheFly = _FilledFromSumOnTheFly 
    ...
    If pTempDist IsNot Nothing AndAlso pTempDist.Count > 0 Then 
      'This is faster 
      For Each pRole As csRole In pTempDist.Values
        If pRole.Tag.ToLowerInvariant() = vTag Then
          Dim pRoleClone As csRole = pRole.Clone()
          pRoles.Add(pRoleClone)
          If Not _FilledFromSumOnTheFly Then pRoles._Clean.Add(pRole.ID) 
        End If
  ...
  Public Overrides Function LoadMeIntoDataTable(ByVal vDataTable As DataTable, ByVal vRequester As clsRequester) As clsFault 
    ...
    For Each pRole As csRole In Me 
      ...
      pFault = pRole.LoadDataRow(pRow, vRequester) 
      If pFault.isOK = False Then Return pFault 
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.Update
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleView, "csRoleCol_Update", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    'Check for new rows 
    For Each p As csRole In Me 
    ...
    If _Clean IsNot Nothing Then 'Since it's private, it will always be nothing when coming from a web service. (The same process was already done in WSController) 
      For Each pCleanID As Long In _Clean 
        ...
        Dim pFound As csRole = Me.FindByID(pCleanID) 
        If pFound.ID = 0 Then 
          Dim pRoleToKill As New csRole 
          pRoleToKill.ID = pCleanID 
          pRoleToKill.ccStatus = clsEnums.enmObjectStatus.Deleted 
          Me.Add(pRoleToKill) 
        End If 
      Next 
    End If 
    ...
    For Each pExists As csRole In Me 
      ...
      ElseIf pExists.ccStatus = clsEnums.enmObjectStatus.UD Then 
        ...
        Return pFault.LogFreeTextFault("Status should not be UD ", pFunctionParameters, "TRGT-Role-130415-0942", vRequester) 
      End If 
    Next 
  ...
  Public Function UpdateFromCollection(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.UpdateFromCollection 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleUpdate, "csRoleCol_UpdateFromCollection", vRequester) 
    If pFault.isOK = False Then Return pFault 
  ...
  Public Shared Function Delete(ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRoleCol_Delete", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "c_RolesDelete" 
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      pFault = MyController.DBCache.SaveData(New csRoleCol(), vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
  ...
  ''' <summary>
  ''' Deletes a collection of all the items for a specific BaseRoleID 
  ''' </summary>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Shared Function DeleteByBaseRoleID(ByVal vBaseRoleID As Long, ByVal vRequester As clsRequester) As clsFault
    Dim pFunctionParameters As String = String.Format("BaseRoleID={0}", vBaseRoleID)
    Dim pFault As New clsFault
 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRoleCol_DeleteByBaseRoleID", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "c_RolesDeleteByBaseRoleID"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Dim pAllRoles As New csRoleCol() : pAllRoles.Fill(vRequester) : If Not pFault.isOK Then Return pFault 
      Dim pFilteredRoles As csRoleCol = pAllRoles.CloneByBaseRoleID(vBaseRoleID) 
      For Each l In pFilteredRoles 
        pAllRoles.Remove(pAllRoles.FindByID(l.ID)) 
      Next 
      pFault = MyController.DBCache.SaveData(pAllRoles, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
        'set parameters  
        pLastReadVariableName = "BaseRoleID" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.BigInt).Value = (vBaseRoleID) 
        pLastReadVariableName = "ChangedBy" 
        pDALParameters.Add("ChangedBy", ccDAL.enmSQLDataType.NVarChar, 50).Value = vRequester.UserName
        pLastReadVariableName = "UpdatingLoginID" 
        pDALParameters.Add("UpdatingLoginID", ccDAL.enmSQLDataType.BigInt).Value = vRequester.LoggedLoginID
  ...
  Public Shared Function DeleteByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRoleCol_DeleteByBoundedID", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "c_RolesDeleteByBoundedID"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("Function not implemented", pFunctionParameters, "TRGT-Role-150216-2148", vRequester) 
    Else 
        Dim pLastReadVariableName As String = "" 
      Try 
        'set parameters  
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090210-1341", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If
  ...
  ''' <summary>
  ''' Deletes a collection of all the items for a specific Name
  ''' </summary>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Shared Function DeleteByBoundedName(ByVal vNameFrom As String, ByVal vNameTo As String, ByVal vRequester As clsRequester) As clsFault
    Dim pFunctionParameters As String = String.Format("NameFrom={0}, NameTo={1}", vNameFrom, vNameTo)
    Dim pFault As New clsFault
 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRoleCol_DeleteByBoundedName", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "c_RolesDeleteByBoundedName"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
  ...
  ''' <summary>
  ''' Deletes a collection of all the items for a WildCarded Name
  ''' </summary>
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Shared Function DeleteByWildCardName(ByVal vName As String, ByVal vNameWildcardType As clsEnums.enmWildCardType, ByVal vRequester As clsRequester) As clsFault
    Dim pFunctionParameters As String = String.Format("Name={0}, NameWildcardType={1}", vName, vNameWildcardType.FastToString())
    Dim pFault As New clsFault
 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_c_RoleDelete, "csRoleCol_DeleteByWildCardName", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Dim pCommandText As String = "c_RolesDeleteByWildCardName"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("Function not implemented", pFunctionParameters, "TRGT-Role-150216-2154", vRequester) 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
        'set parameters  
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-090219-1632", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If
  ...
  Public Sub SortByID()
    Me.Sort(New csRoleCol.CompareByID)
  End Sub
  Private Class CompareByID
    Implements IComparer(Of csRole)
    Private Function Compare(ByVal x As csRole, ByVal y As csRole) As Integer Implements System.Collections.Generic.IComparer(Of csRole).Compare
  ...
  Public Sub SortByName()
    Me.Sort(New csRoleCol.CompareByName)
  End Sub
  ...
  Public Sub SortByBaseRoleID()
    Me.Sort(New csRoleCol.CompareByBaseRoleID)
  End Sub
  Private Class CompareByBaseRoleID
    Implements IComparer(Of csRole)
    Private Function Compare(ByVal x As csRole, ByVal y As csRole) As Integer Implements System.Collections.Generic.IComparer(Of csRole).Compare
      If x Is Nothing AndAlso y Is Nothing Then Return 0
      If x Is Nothing And Not y Is Nothing Then Return 1
      If Not x Is Nothing And y Is Nothing Then Return -1
      If x.BaseRoleID < y.BaseRoleID Then
        Return -1
      ElseIf x.BaseRoleID = y.BaseRoleID Then
        Return 0
      Else
        Return 1
      End If
  ...
  Public Sub SortByBaseRoleText()
    Me.Sort(New csRoleCol.CompareByBaseRoleText)
  End Sub
  Private Class CompareByBaseRoleText
    Implements IComparer(Of csRole)
    Private Function Compare(ByVal x As csRole, ByVal y As csRole) As Integer Implements System.Collections.Generic.IComparer(Of csRole).Compare
      If x Is Nothing AndAlso y Is Nothing Then Return 0
      If x Is Nothing And Not y Is Nothing Then Return 1
      If Not x Is Nothing And y Is Nothing Then Return -1
      Return String.Compare(x.BaseRoleText, y.BaseRoleText, StringComparison.OrdinalIgnoreCase)
    End Function
  End Class
  
  Public Sub SortByTag()
    Me.Sort(New csRoleCol.CompareByTag)
  End Sub
...
#Region "Load Collection"  
  Friend Function LoadMeFromIDataReader(vReader As IDataReader, vRequester As clsRequester) As clsFault Implements ITargCCDataReaderUser.LoadMeFromIDataReader 
    ...
    While vReader.Read()
      pRole = New csRole(_WithParents) 
      pFault = pRole.LoadMeFromIDataReader(vReader, vRequester) : If Not pFault.isOK Then Return pFault 
       
      If pRole.ID = 1 AndAlso pRole.Name <> "Master" Then Throw New Exception("Master must have an ID of 1 in c_Roles") 
      If pRole.Name = "Master" AndAlso pRole.ID <> 1 Then Throw New Exception("Master must have an ID of 1 in c_Roles") 
      Me.Add(pRole)
      If Not _FilledFromSumOnTheFly Then _Clean.Add(pRole.ID) 
    End While
    vRequester.Tag = "" 
  ...
  Private Function LoadMeFromDBCache(ByVal vCachedRoleCol As csRoleCol, ByVal vRequester As clsRequester) As clsFault 
    Dim pFunctionParameters As String = "" 
    Dim pFault As New clsFault 
    ...
    Try 
      ...
      For Each pCachedRole As csRole In vCachedRoleCol 
        pCachedRole.SetWithParents(_WithParents) 
        pRole = New csRole(pCachedRole) 
        If _WithParents = clsEnums.enmLoadParent.DoNotLoad Then 
          pRole.BaseRoleText = "." 
        End If 
        pRole.ccStatus = clsEnums.enmObjectStatus.Clean 
        Me.Add(pRole) 
        If Not _FilledFromSumOnTheFly Then _Clean.Add(pRole.ID) 
      Next 
      If _WithParents = clsEnums.enmLoadParent.EntireObject Then 
      ...
      pFault.SetOK() 
      Catch ex As Exception 
        pFault.LogException(ex, pFunctionParameters, "TRGT-Role-121122-1513", vRequester) 
      End Try 
...
#End Region 
  ...
  Private Overloads Sub Clear() 
    ...
    _SortedDictionaryForFindByID = New Dictionary(Of Long, csRole) 
    _RecreateDictionaryForFindByID = False 
    _SortedDictionaryForFindByName = New Dictionary(Of String, csRole)(StringComparer.OrdinalIgnoreCase) 
    _RecreateDictionaryForFindByName = False 
  End Sub 
