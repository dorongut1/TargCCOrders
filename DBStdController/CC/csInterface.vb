...
Public Interface ITargCCDataReaderUser

  Function LoadMeFromIDataReader(ByVal vReader As System.Data.IDataReader, ByVal vRequester As clsRequester) As clsFault
End Interface
