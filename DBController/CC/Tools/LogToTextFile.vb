...
Namespace Tools
  ...
  Public Class LogToTextFile
    ...
    Friend Shared Function GetSQLErrorAndWriteToFile(vClass As String, vQuery As String, ByVal SqlErrors As SqlErrorCollection, Optional vLogPrefix As String = "SQL") As String
      Dim ResponseReturned As String
      Dim ErrorMessageSaved As String

      ResponseReturned = "SQL Failure!" & Environment.NewLine
      ResponseReturned &= "In " & vClass & "," & Environment.NewLine
      ResponseReturned &= "Query: " & vQuery & Environment.NewLine
      ErrorMessageSaved = "Class: " & vClass & ", Query: " & vQuery & Environment.NewLine
      For i As Integer = 0 To SqlErrors.Count - 1
        ResponseReturned &= (i + 1).ToString() & ".: " & SqlErrors(i).Message & Environment.NewLine
        ErrorMessageSaved &= (i + 1).ToString() & ".: " & SqlErrors(i).Message & Environment.NewLine
      Next i

      WriteMessage(ErrorMessageSaved, vLogPrefix)
