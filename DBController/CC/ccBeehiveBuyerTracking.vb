Public Class clsBeehiveBuyerTracking
  ...
  Public Property [IsRelevant]() As Boolean
    ...
    Set(ByVal value As Boolean)
      If Me._IsRelevant <> value Then 
        bccStatus = clsEnums.enmObjectStatus.Dirty 
        Me._IsRelevant = value 
      End If 
    End Set
  End Property
  ...
  Public Overrides Function GetByPrimaryKey(ByVal vPrimaryKeyValue As Long, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTracking_GetByPrimaryKey", vRequester) 
    ...
    If pEnteredHere = True Then pFault = ccSecurity.GetPermissionForExternalIndentityTypeForEntity(Me, "clsBeehiveBuyerTracking_GetByPrimaryKey", vRequester) : If Not pFault.isOK Then CreateEmpty() : Return pFault 
  ...
  Public Overrides Function GetByParameters(ByVal vParametersType As [Enum], ByVal vParameters As List(Of Object), ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTracking_GetByParameters", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    'only check if this function was accessed directly from outside DBController 
    If pEnteredHere = True Then pFault = ccSecurity.GetPermissionForExternalIndentityTypeForEntity(Me, "clsBeehiveBuyerTracking_GetByParameters", vRequester) : If Not pFault.isOK Then CreateEmpty() : Return pFault 
  ...
  Public Function GetByID(ByVal vID As Long, ByVal vRequester As clsRequester, Optional vMustExist As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTracking_GetByID", vRequester) 
    If Not pFault.isOK Then Return pFault 
    
    CreateEmpty() 
    
    If vID = 0 Then 
      If vMustExist Then Return pFault.LogFreeTextFault(70, $"BeehiveBuyerTracking not found for GetByID, since its value is 0", pFunctionParameters, "TRGT-BeehiveBuyerTracking-210927-1527", vRequester, vAdditionalMessageToUser:=$"BeehiveBuyerTracking not found") 
      pFault.SetOK() 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      pFault = LoadMeFromDBCache(MyController.DBCache.BeehiveBuyerTrackingCol.FindByID(vID), vRequester) : If pFault.isOK = False Then Return pFault
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingGetByID" 
      ...
      Try 
        ...
        If (vMustExist AndAlso Me.IsEmpty) Then pFault.LogFreeTextFault(70, $"BeehiveBuyerTracking not found for GetByID. See FunctionParameters for values", pFunctionParameters, "TRGT-BeehiveBuyerTracking-210625-0950", vRequester, vAdditionalMessageToUser:=$"BeehiveBuyerTracking not found") 
      Catch ex As Exception 
        ...
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090623-1648", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
       
    'only check if this function was accessed directly from outside DBController 
    If pEnteredHere = True Then pFault = ccSecurity.GetPermissionForExternalIndentityTypeForEntity(Me, "clsBeehiveBuyerTracking_GetByID", vRequester) : If Not pFault.isOK Then CreateEmpty() : Return pFault 
  ...
  Public Function AddUpdate(vRequester As clsRequester, Optional vReload As Boolean = True) As clsFault Implements ITargCCEntityAddable.AddUpdate 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingUpdate, "clsBeehiveBuyerTracking_AddUpdate", vRequester) 
    If pFault.isOK = False Then Return pFault 
  ...
  Public Function EditUpdate(vRequester As clsRequester, Optional vReload As Boolean = True) As clsFault Implements ITargCCEntityEditable.EditUpdate 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingUpdate, "clsBeehiveBuyerTracking_EditUpdate", vRequester) 
    If pFault.isOK = False Then Return pFault 
  ...
  Friend Function UpdateFriend(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingUpdate, "clsBeehiveBuyerTracking_UpdateFriend", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Dim pBeehiveBuyerTracking As New clsBeehiveBuyerTracking(_WithParents) 
    If Me.isEqual(pBeehiveBuyerTracking) Then 
      Return pFault.LogFreeTextFault(53, "Object is 'New' - contains no data ", pFunctionParameters, "TRGT-BeehiveBuyerTracking-100113-1638", vRequester) 
    End If 
    ...
    Dim pCommandText As String = "ccBeehiveBuyerTrackingUpdateFriend"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pCachedBeehiveBuyerTracking As clsBeehiveBuyerTracking 
      If _ID = 0 Then 
        pCachedBeehiveBuyerTracking = New clsBeehiveBuyerTracking(_WithParents) 
        'get last ID 
        Dim pBeehiveBuyerTrackingCol As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.Clone() 
        If pBeehiveBuyerTrackingCol.Count = 0 Then 
          _ID = 1 
        Else 
          pBeehiveBuyerTrackingCol.SortByID() 
          Dim pLastID As Long = pBeehiveBuyerTrackingCol(pBeehiveBuyerTrackingCol.Count - 1).ID
          _ID = pLastID + 1 
        End If 
        bPrimaryKey = _ID 
        MyController.DBCache.BeehiveBuyerTrackingCol.Add(pCachedBeehiveBuyerTracking) 
      Else  
        pCachedBeehiveBuyerTracking = MyController.DBCache.BeehiveBuyerTrackingCol.FindByID(_ID) 
      End If 
      pCachedBeehiveBuyerTracking.AssignValues(Me) 
      'Save File 
      pFault = MyController.DBCache.SaveData(MyController.DBCache.BeehiveBuyerTrackingCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
        ...
        pLastReadVariableName = "LastOrderDate" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.Date).Value = ccHelper.DateNullable(_LastOrderDate) 
        pLastReadVariableName = "BeehiveQuantity" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.Int).Value = (_BeehiveQuantity) 
        pLastReadVariableName = "ReminderMonth" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.Int).Value = (_ReminderMonth) 
        pLastReadVariableName = "blg_IsRelevant" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.Bit).Value = (_IsRelevant) 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            ...
            bPrimaryKey = pID 
            If pID = 0 Then 
              pFault.LogFreeTextFault(51, "ID returned is 0!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-151114-1147", vRequester) 
            End If 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-160324-1700", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090623-1809", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingUpdate, "clsBeehiveBuyerTracking_Update", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    Dim pCommandText As String = "ccBeehiveBuyerTrackingUpdate"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
  ...
  Public Function Delete(ByVal vRequester As clsRequester) As clsFault Implements ITargCCEntityDeletable.Delete 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTracking_Delete", vRequester) 
    If Not pFault.isOK Then Return pFault 
    ...
    Dim pCommandText As String = "ccBeehiveBuyerTrackingDelete" 
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      MyController.DBCache.BeehiveBuyerTrackingCol.Remove(MyController.DBCache.BeehiveBuyerTrackingCol.FindByID(_ID)) 
      'Save File 
      pFault = MyController.DBCache.SaveData(MyController.DBCache.BeehiveBuyerTrackingCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      ...
      Try 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            ...
            If pID <> -1 Then pFault.LogFreeTextFault(51, "I expected to get -1 back!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-151114-1147", vRequester) 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-160324-1700", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090623-1813", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If
  ...
  Public Shared Function DeleteByID(vID As Long, vRequester As clsRequester) As clsFault 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTracking_DeleteByID", vRequester) 
    If Not pFault.isOK Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      MyController.DBCache.BeehiveBuyerTrackingCol.Remove(MyController.DBCache.BeehiveBuyerTrackingCol.FindByID(vID)) 
      'Save File  
      pFault = MyController.DBCache.SaveData(MyController.DBCache.BeehiveBuyerTrackingCol, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      ...
      Try 
        ...
        If pFault.isOK = True Then 
          If pTargCCReader.HasRows = True Then 
            pTargCCReader.Read() 
            Dim pID As Integer = ccHelper.ToInteger(pTargCCReader(0)) 
            If pID <> -1 Then pFault.LogFreeTextFault(51, "I expected to get -1 back!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-231207-0845", vRequester) 
          Else 
            pFault.LogFreeTextFault(51, "No response returned from SQL query!", pFunctionParameters, "TRGT-BeehiveBuyerTracking-231207-0844", vRequester) 
          End If 
        End If 
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-231207-0843", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If 
...
#Region "Load Entity" 
  Friend Function LoadMeFromIDataReader(vReader As IDataReader, vRequester As clsRequester) As clsFault Implements ITargCCDataReaderUser.LoadMeFromIDataReader 
    ...
    Try
      ...
      pLastReadVariableName = "LastOrderDate" 
      If Not vReader.IsDBNull(2) Then _LastOrderDate = vReader.GetDateTime(2)
      pLastReadVariableName = "BeehiveQuantity" 
      If Not vReader.IsDBNull(3) Then _BeehiveQuantity = vReader.GetInt32(3)
      pLastReadVariableName = "ReminderMonth" 
      If Not vReader.IsDBNull(4) Then _ReminderMonth = vReader.GetInt32(4)
      pLastReadVariableName = "blg_IsRelevant" 
      If Not vReader.IsDBNull(5) Then _IsRelevant = vReader.GetBoolean(5)
      pLastReadVariableName = "Notes" 
      ...
      If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
        ...
        If Not vReader.IsDBNull(8) Then _CustomerText = vReader.GetString(8) 
    ...
    Catch ex As Exception
      If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
      pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090624-1143", vRequester)
    End Try
  ...
  Private Function LoadMeFromDBCache(ByVal vCachedBeehiveBuyerTracking As clsBeehiveBuyerTracking, ByVal vRequester As clsRequester) As clsFault 
    Dim pFunctionParameters As String = "" 
    Dim pFault As New clsFault 
    ...
    Try 
      AssignValues(vCachedBeehiveBuyerTracking) 
      ...
      pFault.SetOK() 
    Catch ex As Exception 
      pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-121122-1607", vRequester) 
    End Try 
...
Public Class clsBeehiveBuyerTrackingCol
  ...
  Public Sub CleanCollectionForXML() 
    ...
    For Each lBeehiveBuyerTracking As clsBeehiveBuyerTracking In Me 
      lBeehiveBuyerTracking.CleanEntityForXML() 
    Next 
  ...
  Public Overrides Function FillByParameters(ByVal vWhichParameterCombination As [Enum], ByVal vParameters As List(Of Object), ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByParameters", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillByParameters", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Overrides Function Fill(ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_Fill", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.Clone() 
      pBeehiveBuyerTrackingsCached.SortByID() : If vDir = clsEnums.enmFillDirection.DESC Then pBeehiveBuyerTrackingsCached.Reverse() 
      If vHowMany > 0 AndAlso pBeehiveBuyerTrackingsCached.Count > vHowMany Then 
        Dim tmp As New clsBeehiveBuyerTrackingCol 
        For i = 0 To vHowMany - 1 
          tmp.Add(pBeehiveBuyerTrackingsCached(i)) 
        Next 
        pBeehiveBuyerTrackingsCached = tmp 
      End If 
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFill"
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090624-1625", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_Fill", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Function FillByCustomerID(ByVal vCustomerID As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByCustomerID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.CloneByCustomerID(vCustomerID)
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillByCustomerID" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090624-1702", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillByCustomerID", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Function FillByReminderMonth(ByVal vReminderMonth As Integer, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByReminderMonth", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.CloneByReminderMonth(vReminderMonth)
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillByReminderMonth" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        'set parameters 
        pLastReadVariableName = "ReminderMonth" 
        pDALParameters.Add(pLastReadVariableName, ccDAL.enmSQLDataType.Int).Value = (vReminderMonth) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillByReminderMonth", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Function FillByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByBoundedID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.CloneByBoundedID(vIDFrom, vIDTo)
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
        Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillByBoundedID" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-151113-1405", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillByBoundedID", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Function FillByBoundedReminderMonth(ByVal vReminderMonthFrom As Integer, ByVal vReminderMonthTo As Integer, ByVal vRequester As clsRequester, Optional ByVal vHowMany As Integer = 0, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByBoundedReminderMonth", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      If MyController.DBCache.BeehiveBuyerTrackingCol.Count = 0 Then Dim pResponse As String = MyController.DBCache.LoadTableFromFileSystem(MyController.DBCache.BeehiveBuyerTrackingCol) : If Not pResponse.Equals("OK", StringComparison.OrdinalIgnoreCase) Then Throw New Exception("Load clsBeehiveBuyerTrackingCol failed: " & pResponse) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.CloneByBoundedReminderMonth(vReminderMonthFrom, vReminderMonthTo)
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsCached, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
        Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillByBoundedReminderMonth" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
   
      Dim pLastReadVariableName As String = "" 
      Try 
        'set parameters 
        pLastReadVariableName = "ReminderMonthFrom" 
        pDALParameters.Add("bndReminderMonthFrom", ccDAL.enmSQLDataType.Int).Value = (vReminderMonthFrom) 
        pLastReadVariableName = "ReminderMonthTo" 
        pDALParameters.Add("bndReminderMonthTo", ccDAL.enmSQLDataType.Int).Value = (vReminderMonthTo) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillByBoundedReminderMonth", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Function FillByListOfID(vIDs As List(Of Long), vRequester As clsRequester, Optional ByVal vDir As clsEnums.enmFillDirection = clsEnums.enmFillDirection.ASC, Optional vAppend As Boolean = False) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillByListOfID", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    For Each l In vIDs 
      ...
      Dim lBeehiveBuyerTracking As New clsBeehiveBuyerTracking() 
      pFault = lBeehiveBuyerTracking.GetByID(l, vRequester) : If Not pFault.isOK Then Return pFault 
      If Not lBeehiveBuyerTracking.IsEmpty Then Me.Add(lBeehiveBuyerTracking) 
    Next 
  ...
  Public Overrides Function FillOnTheFly(ByVal vParameters As Dictionary(Of System.Enum, Object), ByVal vRequester As clsRequester) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillOnTheFly", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillOnTheFly", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Overloads Function FillOnTheFly( _
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      'Return pFault.LogFreeTextFault("FillOnTheFly has not been handled yet locally", pFunctionParameters, "TRGT-BeehiveBuyerTracking-121122-2008", vRequester) 
      Dim pBeehiveBuyerTrackingsCached As clsBeehiveBuyerTrackingCol = MyController.DBCache.BeehiveBuyerTrackingCol.Clone() 
      Dim pBeehiveBuyerTrackingsToUse As New clsBeehiveBuyerTrackingCol() 
      For Each l In pBeehiveBuyerTrackingsCached 
        ...
        End If 
        If vReminderMonthFrom.HasValue Then 
          If vReminderMonthTo.HasValue Then 
            If l.ReminderMonth < vReminderMonthFrom OrElse l.ReminderMonth > vReminderMonthTo.Value Then Continue For 
          Else 
            If l.ReminderMonth <> vReminderMonthFrom.Value Then Continue For 
          End If 
        End If 
        pBeehiveBuyerTrackingsToUse.Add(l) 
      Next 
      pBeehiveBuyerTrackingsToUse.SortByID() : If vDir = clsEnums.enmFillDirection.DESC Then pBeehiveBuyerTrackingsToUse.Reverse() 
      If vHowMany > 0 AndAlso pBeehiveBuyerTrackingsToUse.Count > vHowMany Then 
        Dim tmp As New clsBeehiveBuyerTrackingCol 
        For i = 0 To vHowMany - 1 
          tmp.Add(pBeehiveBuyerTrackingsToUse(i)) 
        Next 
        pBeehiveBuyerTrackingsToUse = tmp 
      End If 
      pFault = LoadMeFromDBCache(pBeehiveBuyerTrackingsToUse, vRequester) : If pFault.isOK = False Then Return pFault 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillOnTheFly" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pLastReadVariableName = "ReminderMonthFrom" 
        pDALParameters.Add("bndReminderMonthFrom", ccDAL.enmSQLDataType.Int).Value = ccHelper.ObjectNullable(vReminderMonthFrom) 
        pLastReadVariableName = "ReminderMonthTo" 
        pDALParameters.Add("bndReminderMonthTo", ccDAL.enmSQLDataType.Int).Value = ccHelper.ObjectNullable(vReminderMonthTo) 
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090303-1658", vRequester) 
      End Try 
      If Not pFault.isOK Then Return pFault 
    End If
  ...
  Public Overrides Function FillSumOnTheFly(ByVal vParameters As Dictionary(Of [Enum], Object), ByVal vRequester As clsRequester) As clsFault 
    ...
    Dim pEnteredHere As Boolean = String.IsNullOrEmpty(vRequester.EntryFunction) 
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_FillSumOnTheFly", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    If pEnteredHere = True Then 'only check if this function was accessed directly from outside DBController
      Dim pBeehiveBuyerTrackings As Generic.List(Of ITargCCEntity) = Nothing 
      pFault = ccSecurity.GetPermissionForExternalIndentityTypeForCollection(Me, pBeehiveBuyerTrackings, "clsBeehiveBuyerTrackingCol_FillSumOnTheFly", vRequester) : If Not pFault.isOK Then Return pFault 
      If pBeehiveBuyerTrackings IsNot Nothing AndAlso Me.Count <> pBeehiveBuyerTrackings.Count Then FillFromListOfITargCCEntity(pBeehiveBuyerTrackings) 
    End If 
  ...
  Public Overloads Function FillSumOnTheFly( _
    ...
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("FillSumOnTheFly has not been handled yet locally", pFunctionParameters, "TRGT-BeehiveBuyerTracking-121122-2008", vRequester) 
    Else 
      Dim pCancel As Boolean = False 
      Dim pCommandText As String = "ccBeehiveBuyerTrackingsFillSumOnTheFly" 
      Dim pDALParameters As New ccDAL.csTargCCParameterCol 
      ...
      Try 
        ...
        pLastReadVariableName = "ReminderMonth" 
        pDALParameters.Add("GroupByReminderMonth", ccDAL.enmSQLDataType.Bit).Value = vGroupByReminderMonth
        pLastReadVariableName = "WithParentText" 
        If _WithParents = clsEnums.enmLoadParent.TextOnly Then 
          pDALParameters.Add("WithParentText", ccDAL.enmSQLDataType.Bit).Value = True 
        Else 
  ...
  Public Function LoadParents(ByVal vRequester As clsRequester) As clsFault
    Dim pFault As New clsFault
    For Each pBeehiveBuyerTracking As clsBeehiveBuyerTracking In Me
      pFault = pBeehiveBuyerTracking.LoadParents(vRequester)
      If pFault.isOK = False Then Return pFault
    Next
    _WithParents = clsEnums.enmLoadParent.EntireObject 
    pFault.SetOK()
  ...
  Public Function Update(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.Update
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingView, "clsBeehiveBuyerTrackingCol_Update", vRequester) 
    If pFault.isOK = False Then Return pFault 
    ...
    For Each pExists As clsBeehiveBuyerTracking In Me 
      ...
      ElseIf pExists.ccStatus = clsEnums.enmObjectStatus.UD Then 
        ...
        Return pFault.LogFreeTextFault("Status should not be UD ", pFunctionParameters, "TRGT-BeehiveBuyerTracking-130415-0942", vRequester) 
      End If 
    Next 
  ...
  Public Function UpdateFromCollection(ByVal vRequester As clsRequester, Optional ByVal vReload As Boolean = True) As clsFault Implements ITargCCCollectionUpdateable.UpdateFromCollection 
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingUpdate, "clsBeehiveBuyerTrackingCol_UpdateFromCollection", vRequester) 
    If pFault.isOK = False Then Return pFault 
  ...
  Public Shared Function Delete(ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTrackingCol_Delete", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "ccBeehiveBuyerTrackingsDelete" 
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      pFault = MyController.DBCache.SaveData(New clsBeehiveBuyerTrackingCol(), vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
  ...
  Public Shared Function DeleteByCustomerID(ByVal vCustomerID As Long, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTrackingCol_DeleteByCustomerID", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "ccBeehiveBuyerTrackingsDeleteByCustomerID"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Dim pAllBeehiveBuyerTrackings As New clsBeehiveBuyerTrackingCol() : pAllBeehiveBuyerTrackings.Fill(vRequester) : If Not pFault.isOK Then Return pFault 
      Dim pFilteredBeehiveBuyerTrackings As clsBeehiveBuyerTrackingCol = pAllBeehiveBuyerTrackings.CloneByCustomerID(vCustomerID) 
      For Each l In pFilteredBeehiveBuyerTrackings 
        pAllBeehiveBuyerTrackings.Remove(pAllBeehiveBuyerTrackings.FindByID(l.ID)) 
      Next 
      pFault = MyController.DBCache.SaveData(pAllBeehiveBuyerTrackings, vRequester) 
      If pFault.isOK = False Then Return pFault 
    Else 
      Dim pLastReadVariableName As String = "" 
      Try 
  ...
  Public Shared Function DeleteByReminderMonth(ByVal vReminderMonth As Integer, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTrackingCol_DeleteByReminderMonth", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "ccBeehiveBuyerTrackingsDeleteByReminderMonth"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Dim pAllBeehiveBuyerTrackings As New clsBeehiveBuyerTrackingCol() : pAllBeehiveBuyerTrackings.Fill(vRequester) : If Not pFault.isOK Then Return pFault 
      Dim pFilteredBeehiveBuyerTrackings As clsBeehiveBuyerTrackingCol = pAllBeehiveBuyerTrackings.CloneByReminderMonth(vReminderMonth) 
      For Each l In pFilteredBeehiveBuyerTrackings 
        pAllBeehiveBuyerTrackings.Remove(pAllBeehiveBuyerTrackings.FindByID(l.ID)) 
      Next 
      pFault = MyController.DBCache.SaveData(pAllBeehiveBuyerTrackings, vRequester) 
  ...
  Public Shared Function DeleteByBoundedID(ByVal vIDFrom As Long, ByVal vIDTo As Long, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTrackingCol_DeleteByBoundedID", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "ccBeehiveBuyerTrackingsDeleteByBoundedID"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
 
    If MyController.DBType = MyController.enmDBType.FileSystem Then 
      Return pFault.LogFreeTextFault("Function not implemented", pFunctionParameters, "TRGT-BeehiveBuyerTracking-150216-2148", vRequester) 
    Else 
        Dim pLastReadVariableName As String = "" 
      Try 
        'set parameters  
      ...
      Catch ex As Exception 
        If pLastReadVariableName <> "" Then pFunctionParameters = "Failed while reading variable: " & pLastReadVariableName & "; " & pFunctionParameters 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-090210-1341", vRequester) 
      End Try 
      If pFault.isOK = False Then Return pFault 
    End If
  ...
  Public Shared Function DeleteByBoundedReminderMonth(ByVal vReminderMonthFrom As Integer, ByVal vReminderMonthTo As Integer, ByVal vRequester As clsRequester) As clsFault
    ...
    pFault = ccSecurity.GetPermissionForDBControllerFunction(clsEnums.enmProcess.tbl_BeehiveBuyerTrackingDelete, "clsBeehiveBuyerTrackingCol_DeleteByBoundedReminderMonth", vRequester) 
    If pFault.isOK = False Then Return pFault 
 
    Dim pCommandText As String = "ccBeehiveBuyerTrackingsDeleteByBoundedReminderMonth"
    Dim pDALParameters As New ccDAL.csTargCCParameterCol 
...
#Region "Load Collection"  
  Friend Function LoadMeFromIDataReader(vReader As IDataReader, vRequester As clsRequester) As clsFault Implements ITargCCDataReaderUser.LoadMeFromIDataReader 
    ...
    While vReader.Read()
      pBeehiveBuyerTracking = New clsBeehiveBuyerTracking(_WithParents) 
      pFault = pBeehiveBuyerTracking.LoadMeFromIDataReader(vReader, vRequester) : If Not pFault.isOK Then Return pFault 
       
      Me.Add(pBeehiveBuyerTracking)
      If Not _FilledFromSumOnTheFly Then _Clean.Add(pBeehiveBuyerTracking.ID) 
    End While
    vRequester.Tag = "" 
  ...
  Private Function LoadMeFromDBCache(ByVal vCachedBeehiveBuyerTrackingCol As clsBeehiveBuyerTrackingCol, ByVal vRequester As clsRequester) As clsFault 
    Dim pFunctionParameters As String = "" 
    Dim pFault As New clsFault 
    ...
    Try 
      ...
      For Each pCachedBeehiveBuyerTracking As clsBeehiveBuyerTracking In vCachedBeehiveBuyerTrackingCol 
        pCachedBeehiveBuyerTracking.SetWithParents(_WithParents) 
        pBeehiveBuyerTracking = New clsBeehiveBuyerTracking(pCachedBeehiveBuyerTracking) 
        If _WithParents = clsEnums.enmLoadParent.DoNotLoad Then 
          pBeehiveBuyerTracking.CustomerText = "." 
        End If 
        pBeehiveBuyerTracking.ccStatus = clsEnums.enmObjectStatus.Clean 
        Me.Add(pBeehiveBuyerTracking) 
        If Not _FilledFromSumOnTheFly Then _Clean.Add(pBeehiveBuyerTracking.ID) 
      Next 
      If _WithParents = clsEnums.enmLoadParent.EntireObject Then 
      ...
      pFault.SetOK() 
      Catch ex As Exception 
        pFault.LogException(ex, pFunctionParameters, "TRGT-BeehiveBuyerTracking-121122-1513", vRequester) 
      End Try 
